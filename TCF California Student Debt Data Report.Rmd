...
Q42.S$Program <- rep("Stafford", nrow(Q42.S))
Q42.P$Program <- rep("Parent PLUS", nrow(Q42.P))
Q42.G$Program <- rep("Grad PLUS", nrow(Q42.G))
...
tblOwnDebt$Race <- factor(tblOwnDebt$Race, levels=c("All", "White, Non-Hispanic", "Hispanic", "Black, Non-Hispanic", "Other, Non-Hispanic"))
