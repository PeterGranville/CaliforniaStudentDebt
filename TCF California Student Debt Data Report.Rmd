...
npsas3.1.US.masters.total <- read.csv("PowerStats kxgkel.csv", skip=48, nrow=2, header=FALSE)
...
npsas3.1.US.professional.total <- read.csv("PowerStats kxgkel.csv", skip=156, nrow=2, header=FALSE)
...
**Data source:** National Postsecondary Student Aid Study, Graduate. Datalab interface available [here](https://nces.ed.gov/datalab/) using table retrieval numbers *ibxxlt* and *zlasyt* for "Figure 4: Race" and table retrieval numbers *gouiaq*, *kxgkel*, *iuyjsr*, *ajghcg* for "Figure 4: Race and Gender."
...
npsas4.1.US <- read.csv("PowerStats eggovm.csv", skip=12, nrow=14, header=FALSE)
...
npsas4.1.CA <- read.csv("PowerStats eggovm.csv", skip=108, nrow=14, header=FALSE)
...
**Data source:** National Postsecondary Student Aid Study, Undergraduate. Datalab interface available [here](https://nces.ed.gov/datalab/) using table retrieval numbers *rcefsb* and *admfpj* for "Figure 5: Race" and table retrieval number *eggovm*, *gnvptv*, *pnfkhv*, and *elhvny* for "Figure 5: Race and Gender (U.S. only)".
