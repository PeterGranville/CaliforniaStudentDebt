...
g11 <- ggplot(data=tblOwnDebtBehind, mapping=aes(y=Race, x=`Share of borrowers behind on payments`, fill=State, text=`For Tooltip`)) + geom_bar(stat="identity", position="dodge", width=0.7) + scale_x_continuous(labels=scales::percent_format(accuracy=1)) + labs(y="", title="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Dark2")
...
tblUnpaidCC$`For Tooltip` <- paste(
  ...
  "Student loan borrower: ", tblUnpaidCC$AnyStudentLoans, '\n',
...
g15 <- ggplot(data=tblUnpaidCC, mapping=aes(y=Race, x=`Share with unpaid credit card debt`, fill=Group, text=`For Tooltip`)) + geom_bar(stat="identity", position="dodge", width=0.7) + scale_x_continuous(labels=scales::percent_format(accuracy=1), limits=c(0, 1)) + labs(y="", title="", x="Share with outstanding credit card debt", fill="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Dark2") 
...
g23A <- ggplot(data=tblPartialSL, mapping=aes(y=Race, x=`Share of borrowers expecting to be unable to fully pay their student loan bill this month`, fill=Group, text=`For Tooltip`)) + geom_bar(stat="identity", position="dodge", width=0.7) + scale_x_continuous(labels=scales::percent_format(accuracy=1), limits=c(0, 1)) + labs(y="", title="", x="Share who expect to be unable to pay their student loan bill this month", fill="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Dark2") 
...
g23B <- ggplot(data=tblPartialRent, mapping=aes(y=Race, x=`Share of borrowers expecting to be unable to fully pay their rent this month`, fill=Group, text=`For Tooltip`)) + geom_bar(stat="identity", position="dodge", width=0.7) + scale_x_continuous(labels=scales::percent_format(accuracy=1), limits=c(0, 1)) + labs(y="", title="", x="Share who expect to be unable to pay their rent or mortgage bill this month", fill="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Dark2") 
...
g23C <- ggplot(data=tblPartialCC, mapping=aes(y=Race, x=`Share of borrowers expecting to be unable to fully pay their credit card bill this month`, fill=Group, text=`For Tooltip`)) + geom_bar(stat="identity", position="dodge", width=0.7) + scale_x_continuous(labels=scales::percent_format(accuracy=1), limits=c(0, 1)) + labs(y="", title="", x="Share who expect to be unable to pay their credit card bill this month", fill="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Dark2") 
...
tblPayBills400.CA.Borrow$`For Tooltip` <- paste(
  ...
  "Student loan borrower: ", tblPayBills400.CA.Borrow$AnyStudentLoans, '\n',
...
tblPayBills400.US.Borrow$`For Tooltip` <- paste(
  ...
  "Student loan borrower: ", tblPayBills400.US.Borrow$AnyStudentLoans, '\n',
...
tblPayBills400.CA.Nonborrow$`For Tooltip` <- paste(
  ...
  "Student loan borrower: ", tblPayBills400.CA.Nonborrow$AnyStudentLoans, '\n',
...
g27 <- ggplot(data=tblCreditDeny, mapping=aes(y=Race, x=`Share of borrowers who were turned down for credit in the past 12 months`, fill=Group, text=`For Tooltip`)) + geom_bar(stat="identity", position="dodge", width=0.7) + scale_x_continuous(labels=scales::percent_format(accuracy=1), limits=c(0, 1)) + labs(y="", title="", x="Share who were turned down for credit in the past 12 months", fill="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Dark2")
...
g28A <- ggplot(data=tblSocSec, mapping=aes(y=Race, x=`Share`, fill=Group, text=`For Tooltip`)) + geom_bar(stat="identity", position="dodge", width=0.7) + scale_x_continuous(labels=scales::percent_format(accuracy=1), limits=c(0, 1)) + labs(y="", title="", x="Share who received Social Security", fill="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Dark2") 
...
g28B <- ggplot(data=tblWelfare, mapping=aes(y=Race, x=`Share`, fill=Group, text=`For Tooltip`)) + geom_bar(stat="identity", position="dodge", width=0.7) + scale_x_continuous(labels=scales::percent_format(accuracy=1), limits=c(0, 1)) + labs(y="", title="", x="Share who received cash assistance (TANF, SSI, etc.)", fill="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Dark2") 
...
g28C <- ggplot(data=tblEITC, mapping=aes(y=Race, x=`Share`, fill=Group, text=`For Tooltip`)) + geom_bar(stat="identity", position="dodge", width=0.7) + scale_x_continuous(labels=scales::percent_format(accuracy=1), limits=c(0, 1)) + labs(y="", title="", x="Share who received the Earned Income Tax Credit", fill="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Dark2") 
...
g28E <- ggplot(data=tblHouseAssist, mapping=aes(y=Race, x=`Share`, fill=Group, text=`For Tooltip`)) + geom_bar(stat="identity", position="dodge", width=0.7) + scale_x_continuous(labels=scales::percent_format(accuracy=1), limits=c(0, 1)) + labs(y="", title="", x="Share who received housing assistance", fill="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Dark2") 
...
g28F <- ggplot(data=tblFRPL, mapping=aes(y=Race, x=`Share`, fill=Group, text=`For Tooltip`)) + geom_bar(stat="identity", position="dodge", width=0.7) + scale_x_continuous(labels=scales::percent_format(accuracy=1), limits=c(0, 1)) + labs(y="", title="", x="Share who received free or reduced price lunch", fill="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Dark2") 
...
```{r figure29A}
tblThreeMonSave$`For Tooltip` <- paste(
  "State: ", tblThreeMonSave$State, '\n',
  "Student loan borrowers: ", tblThreeMonSave$AnyStudentLoans, '\n',
  "Group: ", tblThreeMonSave$Race, '\n',
  "Share with sufficient funds set aside: ", percent(tblThreeMonSave$Share, accuracy=0.1), 
  sep=""
)

g29A <- ggplot(data=tblThreeMonSave, mapping=aes(y=Race, x=`Share`, fill=Group, text=`For Tooltip`)) + geom_bar(stat="identity", position="dodge", width=0.7) + scale_x_continuous(labels=scales::percent_format(accuracy=1), limits=c(0, 1)) + labs(y="", title="", x="Share with sufficient funds set aside", fill="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Dark2") 

ggplotly(g29A, width=800, height=350, tooltip="text")
```
...
```{r figure29B}
tblThreeMonCover$`For Tooltip` <- paste(
  "State: ", tblThreeMonCover$State, '\n',
  "Student loan borrowers: ", tblThreeMonCover$AnyStudentLoans, '\n',
  "Group: ", tblThreeMonCover$Race, '\n',
  "Share who could cover three months' expenses: ", percent(tblThreeMonCover$Share, accuracy=0.1), 
  sep=""
)

g29B <- ggplot(data=tblThreeMonCover, mapping=aes(y=Race, x=`Share`, fill=Group, text=`For Tooltip`)) + geom_bar(stat="identity", position="dodge", width=0.7) + scale_x_continuous(labels=scales::percent_format(accuracy=1), limits=c(0, 1)) + labs(y="", title="", x="Share who could cover three months' expenses", fill="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Dark2") 

ggplotly(g29B, width=800, height=350, tooltip="text")
```
#### Data source and notes
...
g30B <- ggplot(data=tblCCB400, mapping=aes(y=Race, x=`Share`, fill=Group, text=`For Tooltip`)) + geom_bar(stat="identity", position="dodge", width=0.7) + scale_x_continuous(labels=scales::percent_format(accuracy=1), limits=c(0, 1)) + labs(y="", title="", x="Share who would put it on a credit card and pay it off over time", fill="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Dark2") 
...
g30D <- ggplot(data=tblLoan400, mapping=aes(y=Race, x=`Share`, fill=Group, text=`For Tooltip`)) + geom_bar(stat="identity", position="dodge", width=0.7) + scale_x_continuous(labels=scales::percent_format(accuracy=1), limits=c(0, 1)) + labs(y="", title="", x="Share who would pay with a bank loan", fill="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Dark2") 
...
g30E <- ggplot(data=tblFriend400, mapping=aes(y=Race, x=`Share`, fill=Group, text=`For Tooltip`)) + geom_bar(stat="identity", position="dodge", width=0.7) + scale_x_continuous(labels=scales::percent_format(accuracy=1), limits=c(0, 1)) + labs(y="", title="", x="Share who would borrow from family or a friend", fill="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Dark2") 
...
g30F <- ggplot(data=tblPayday400, mapping=aes(y=Race, x=`Share`, fill=Group, text=`For Tooltip`)) + geom_bar(stat="identity", position="dodge", width=0.7) + scale_x_continuous(labels=scales::percent_format(accuracy=1), limits=c(0, 1)) + labs(y="", title="", x="Share who would use a payday loan, deposit advance, or overdraft", fill="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Dark2") 
...
g30G <- ggplot(data=tblSell400, mapping=aes(y=Race, x=`Share`, fill=Group, text=`For Tooltip`)) + geom_bar(stat="identity", position="dodge", width=0.7) + scale_x_continuous(labels=scales::percent_format(accuracy=1), limits=c(0, 1)) + labs(y="", title="", x="Share who would pay by selling something", fill="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Dark2") 
...
g30H <- ggplot(data=tblNone400, mapping=aes(y=Race, x=`Share`, fill=Group, text=`For Tooltip`)) + geom_bar(stat="identity", position="dodge", width=0.7) + scale_x_continuous(labels=scales::percent_format(accuracy=1), limits=c(0, 1)) + labs(y="", title="", x="Share who could not cover the expense", fill="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Dark2") 
