...
This report accompanies The Century Foundation (TCF)'s report "Student Debt and Race in California," which examines how student debt puts outsized financial burdens on Black and Latino families in California. 
...
This report draws from the best available sources of California-specific data on student debt to explain in depth what we know (and still do not know) about student debt in California. In my analysis I rely primarily on four sources:
...
I also draw from the Integrated Postsecondary Education Data System (IPEDS) and the American Community Survey (ACS) to lesser extents. 

In contrast to the policy report, this data-focused document is more descriptive than prescriptive. Even data queries did not show striking contrasts between groups are included for full transparency, so long as they are relevant to the examination of student loan debt's burden on California borrowers. 
