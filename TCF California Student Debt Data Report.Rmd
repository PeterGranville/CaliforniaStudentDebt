...
npsas1.1P$Group <- factor(npsas1.1P$Group, levels = c("Overall", "White", "Latino/a", "Black", "Asian", "Pacific Islander", "2+ races"))
...
npsas2.US.total <- read.csv("Powerstats ozhexe.csv", skip=10, nrow=1, header=FALSE)
npsas2.US <- rbind(npsas2.US.total, npsas2.US)

npsas2.CA <- read.csv("Powerstats ozhexe.csv", skip=73, nrow=7, header=FALSE)
npsas2.CA.total <- read.csv("Powerstats ozhexe.csv", skip=71, nrow=1, header=FALSE)
...
npsas2P.US.total <- read.csv("Powerstats lkxsci.csv", skip=12, nrow=1, header=FALSE) %>% select(V1, V3)
...
npsas2P.CA.total <- read.csv("Powerstats lkxsci.csv", skip=76, nrow=1, header=FALSE) %>% select(V1, V3)
...
npsas2.1.total <- read.csv("Powerstats qnabzw.csv", skip=12, nrow=2, header=FALSE)
...
npsas2.1P.total <- read.csv("Powerstats ietaou.csv", skip=14, nrow=2, header=FALSE) %>% select(V1, V3)
...
**Data source:** National Postsecondary Student Aid Study, Undergraduate. Datalab interface available [here](https://nces.ed.gov/datalab/) using table retrieval numbers *ozhexe* and *lkxsci* for "Figure 3: Race" and *odiegv*, *qnabzw*, *jcbvqb*, and *ietaou* for "Figure 3: Race and Gender."
...
npsas3.US.masters.total <- read.csv("PowerStats enucsq.csv", skip=71, nrow=1, header=FALSE)
...
npsas3.US.professional.total <- read.csv("PowerStats enucsq.csv", skip=254, nrow=1, header=FALSE)
...
npsas3P.US.masters.total <- read.csv("PowerStats lmjixp.csv", skip=76, nrow=1, header=FALSE) %>% select(V1, V3)
...
npsas3P.US.professional.total <- read.csv("PowerStats lmjixp.csv", skip=268, nrow=1, header=FALSE) %>% select(V1, V3)
...
npsas3.1.US.masters.total <- read.csv("PowerStats phedaa.csv", skip=48, nrow=2, header=FALSE)
...
npsas3.1.US.professional.total <- read.csv("PowerStats phedaa.csv", skip=156, nrow=2, header=FALSE)
...
npsas3.1P.US.masters.total <- read.csv("PowerStats noxoew.csv", skip=53, nrow=2, header=FALSE) %>% select(V1, V3)
...
npsas3.1P.US.professional.total <- read.csv("PowerStats noxoew.csv", skip=170, nrow=2, header=FALSE) %>% select(V1, V3)
...
**Data source:** National Postsecondary Student Aid Study, Graduate. Datalab interface available [here](https://nces.ed.gov/datalab/) using table retrieval numbers *enucsq* and *lmjixp* for "Figure 4: Race" and table retrieval numbers *xqcxry*, *phedaa*, *ilzmdk*, *noxoew* for "Figure 4: Race and Gender."
...
npsas4.US.total <- read.csv("PowerStats dxwsoi.csv", skip=10, nrow=1, header=FALSE)
npsas4.US <- rbind(npsas4.US.total, npsas4.US)

npsas4.CA <- read.csv("PowerStats dxwsoi.csv", skip=73, nrow=7, header=FALSE)
npsas4.CA.total <- read.csv("PowerStats dxwsoi.csv", skip=71, nrow=1, header=FALSE)
...
npsas4P.US.total <- read.csv("PowerStats dyclij.csv", skip=12, nrow=1, header=FALSE) %>% select(V1, V3)
...
npsas4P.CA.total <- read.csv("PowerStats dyclij.csv", skip=76, nrow=1, header=FALSE) %>% select(V1, V3)
...
npsas4.1.US.total <- read.csv("PowerStats rrbopj.csv", skip=12, nrow=2, header=FALSE)
npsas4.1.US <- rbind(npsas4.1.US.total, npsas4.1.US)

npsas4.1.CA <- read.csv("PowerStats gkhfjw.csv", skip=108, nrow=14, header=FALSE)
npsas4.1.CA.total <- read.csv("PowerStats rrbopj.csv", skip=48, nrow=2, header=FALSE)
...
npsas4.1P.US.total <- read.csv("PowerStats lpcmjs.csv", skip=14, nrow=2, header=FALSE) %>% select(V1, V3)
...
npsas4.1P.CA.total <- read.csv("PowerStats lpcmjs.csv", skip=53, nrow=2, header=FALSE) %>% select(V1, V3)
...
**Data source:** National Postsecondary Student Aid Study, Undergraduate. Datalab interface available [here](https://nces.ed.gov/datalab/) using table retrieval numbers *dxwsoi* and *dyclij* for "Figure 5: Race" and table retrieval number *gkhfjw*, *rrbopj*, *vylupp*, and *lpcmjs* for "Figure 5: Race and Gender (U.S. only)".
...
tblCCBalance0 <- tblCCBalance %>% filter(Race != "Other, Non-Hispanic") %>% filter(Race != "All") %>% filter(State == "CA" | AnyStudentLoans == "Yes")
...
ggplot(data=tblCCBalance0, mapping=aes(y=Group, x=`Share of borrowers`, fill=variable)) + geom_bar(stat="identity") + facet_wrap(Race ~ ., ncol=1, strip.position=c("top")) + scale_x_continuous(labels=scales::percent_format(accuracy=1)) + labs(fill="", x="Share", y="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Spectral") 
```
