...
g1 <- ggplot(data=table4.1, mapping=aes(x=State, y=`Average Loan`, fill=State, text=`For Tooltip`)) + geom_bar(stat="identity", position="dodge", width=0.4) + labs(title="Average annual loans by type and sector: California vs. Rest of U.S.") + scale_y_continuous(labels=scales::dollar_format()) + facet_grid(Control ~ variable) + scale_fill_brewer(palette="Dark2") + theme(text=element_text(family="Optima")) 

ggplotly(g1, width=850, height=500, tooltip="text")
```
##### Data source and notes
...
npsas1$Group <- factor(npsas1$Group, levels = c("White", "Latino/a", "Black", "Asian", "Pacific Islander", "2+ races"))
...
npsas1$`For Tooltip` <- paste(
  "State: ", npsas1$State, '\n', 
  "Loan type: ", npsas1$variable, '\n',
  "Group: ", npsas1$Group, '\n', 
  "Average annual loans: ", dollar(npsas1$`Average Loan`, accuracy=1), 
  sep="")

g2 <- ggplot(data=npsas1, mapping=aes(x=State, y=`Average Loan`, fill=State, text=`For Tooltip`)) + geom_bar(stat="identity", position="dodge", width=0.4) + labs(title="Average annual undergrad. loans at public 4-years by group: CA vs U.S.") + facet_grid(variable ~ Group) + scale_y_continuous(labels=scales::dollar_format()) + scale_fill_brewer(palette="Dark2") + theme(legend.position="none", text=element_text(family="Optima"))
...
npsas2$Group <- factor(npsas2$Group, levels = c("White", "Latino/a", "Black", "Asian", "2+ races"))
...
npsas4$Group <- factor(npsas4$Group, levels = c("White", "Latino/a", "Black", "Asian", "Pacific Islander", "2+ races"))
...
npsas4.1.US <- read.csv("PowerStats upgkeu.csv", skip=12, nrow=7, header=FALSE)
npsas4.1.CA <- read.csv("PowerStats vsqgcr.csv", skip=12, nrow=7, header=FALSE)

names(npsas4.1.US) <- c("Group", "Average cumulative federal loans")
names(npsas4.1.CA) <- c("Group", "Average cumulative federal loans")
...
npsas4.1 <- npsas4.1 %>% filter(Group != "American Indian or Alaska Native")

npsas4.1$Group[npsas4.1$Group=="Black or African American"] <- "Black"
npsas4.1$Group[npsas4.1$Group=="More than one race"] <- "2+ races"
npsas4.1$Group[npsas4.1$Group=="Hispanic or Latino"] <- "Latino/a"
npsas4.1$Group[npsas4.1$Group=="Native Hawaiian/other Pacific Islander"] <- "Pacific Islander"

npsas4.1$`Average cumulative federal loans` <- as.numeric(npsas4.1$`Average cumulative federal loans`)

npsas4.1$Group <- as.factor(npsas4.1$Group)
npsas4.1$Group <- factor(npsas4.1$Group, levels = c("White", "Latino/a", "Black", "Asian", "Pacific Islander", "2+ races"))
```
##### Figure 5
```{r figure5}
npsas4.1$`For Tooltip` <- paste(
  ...
  "Average cumulative federal loans: ", dollar(npsas4.1$`Average cumulative federal loans`, accuracy=1),
  sep=""
)

g5 <- ggplot(data=npsas4.1, mapping=aes(x=State, y=`Average cumulative federal loans`, fill=State, text=`For Tooltip`)) + geom_bar(stat="identity", position="dodge", width=0.6) + facet_grid(. ~ Group) + scale_y_continuous(label=scales::dollar) + labs(x="State", title="Average cumulative federal loans: Graduating undergraduates", y="Average cumulative loans") + scale_fill_brewer(palette="Dark2") + theme(legend.position="none", text=element_text(family="Optima"))

ggplotly(g5, width=800, height=350, tooltip="text")
```
##### Data source and notes
...
npsas5.ASN$`For Tooltip` <- paste(
  ...
  "Average annual federal loans: ", dollar(npsas5.ASN$`Total federal loans`, accuracy=1), 
  sep=""
)

g6A <- ggplot(data=npsas5.ASN, mapping=aes(y=Group, x=`Total federal loans`, fill=Group, text=`For Tooltip`)) + geom_bar(stat="identity", position="dodge") + labs(title="Average annual federal student loans by Asian ethinicity: U.S. vs CA", x="Average federal student loans") + facet_grid(State ~ .) + scale_x_continuous(labels=scales::dollar_format()) + scale_fill_brewer(palette="Set3") + theme(legend.position="none", text=element_text(family="Optima"))

ggplotly(g6A, width=800, height=500, tooltip="text")
```
...
npsas5.HSP$`For Tooltip` <- paste(
  ...
  "Average annual federal loans: ", dollar(npsas5.HSP$`Total federal loans`, accuracy=1), 
  sep=""
)

g6B <- ggplot(data=npsas5.HSP, mapping=aes(y=Group, x=`Total federal loans`, fill=Group, text=`For Tooltip`)) + geom_bar(stat="identity", position="dodge") + labs(title="Average federal student loans by Hispanic ethinicity: U.S. vs CA", x="Average federal student loans") + facet_grid(State ~ .) + scale_x_continuous(labels=scales::dollar_format()) + scale_fill_brewer(palette="Set3") + theme(legend.position="none", text=element_text(family="Optima"))

ggplotly(g6B, width=800, height=500, tooltip="text")
```
##### Data source and notes
...
g7 <- ggplot(data=tblOwnDebt, mapping=aes(y=Race, x=`Share with debt`, fill=State, text=`For Tooltip`)) + geom_bar(stat="identity", position="dodge", width=0.7) + scale_x_continuous(labels=scales::percent_format(accuracy=1)) + labs(y="", title="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Dark2")

ggplotly(g7, width=800, height=350, tooltip="text")
```
#### Data source and notes

The survey years included for Figure 7 are
...
The survey years included for "Figure 8: Student loans" are
```{r OwnDebtSL.SY, results = 'asis'}
survey_years(shed.OwnDebtSL$SurveyYear)
```

The survey years included for "Figure 8: Home equity" are
```{r OwnDebtHE.SY, results = 'asis'}
survey_years(shed.OwnDebtHE$SurveyYear)
```

The survey years included for "Figure 8: Credit card debt" are
```{r OwnDebtCC.SY, results = 'asis'}
survey_years(shed.OwnDebtCC$SurveyYear)
```
...
g9A <- ggplot(data=tblOwnDebtTot3.CA, mapping=aes(y=Race, x=`Share of borrowers`, fill=variable)) + geom_bar(stat="identity") + scale_x_continuous(labels=scales::percent_format(accuracy=1)) + labs(fill="Total student debt") + labs(y="", title="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Spectral") 

ggplotly(g9A, height=350)
...
g9B <- ggplot(data=tblOwnDebtTot3.US, mapping=aes(y=Race, x=`Share of borrowers`, fill=variable)) + geom_bar(stat="identity") + scale_x_continuous(labels=scales::percent_format(accuracy=1)) + labs(fill="Total student debt") + labs(y="", title="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Spectral") 

ggplotly(g9B, height=350)
...
The survey years included for Figure 9 are
...
ggplotly(g10A, width=800, height=350)
...
The survey years included for Figure 10 are
...
```{r figure11}
g11 <- ggplot(data=tblOwnDebtBehind, mapping=aes(y=Race, x=`Share of borrowers behind on payments`, fill=State)) + geom_bar(stat="identity", position="dodge", width=0.7) + scale_x_continuous(labels=scales::percent_format(accuracy=1)) + labs(y="", title="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Dark2")

ggplotly(g11, height=350)
...
The survey years included for Figure 11 are
...
Figure 12 includes all respondents, not just those who have student debt for their own education. 
"Figure 12: Debt for spouse's or partner's education" does not include survey respondents without a spouse or partner. 
"Figure 12: Debt for child or grandchild's education" does not include survey respondents without children or grandchildren. 

The survey years included for "Figure 12: Debt for spouse's or partner's education" are
```{r SpouseDebt.SY, results = 'asis'}
survey_years(shed.SpouseDebt$SurveyYear)
```

The survey years included for "Figure 12: Debt for child's or grandchild's education" are
```{r ChildDebt.SY, results = 'asis'}
survey_years(shed.ChildDebt$SurveyYear)
```
...
The survey years included for Figure 13 are
```{r EdAttain.SY, results = 'asis'}
survey_years(shed.EdAttain$SurveyYear)
```

```{r EdAttain.N}
N.EdAttain <- aggregate(data=shed.EdAttain, Count ~ Race + State + AnyStudentLoans, FUN=sum)
N.EdAttain <- N.EdAttain %>% filter(State=="CA" | AnyStudentLoans=="Yes")
names(N.EdAttain) <- c("Group", "State", "Student loan borrower", "Survey respondents")
kable(N.EdAttain, caption="N size by group for Figure 13") %>% kable_paper("hover", full_width = F)
```
...
ggplotly(g14C, width=800, height=350)
...
The survey years included for Figure 14 are
...
The survey years included for Figure 15 are
...
The survey years included for Figure 16 are
...
The survey years included for Figure 17 are
...
The survey years included for Figure 18 are
...
The survey years included for Figure 19 are
...
g20C <- ggplot(data=tblParComp.CA.Nonborrow, mapping=aes(y=Race, x=`Share of borrowers`, fill=variable)) + geom_bar(stat="identity") + scale_x_continuous(labels=scales::percent_format(accuracy=1)) + labs(fill="", x="Share of non-borrowers in California", y="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Spectral") 
...
The survey years included for Figure 20 are
...
g21A <- ggplot(data=tblCreditScore.CA.Borrow, mapping=aes(y=Race, x=`Share`, fill=variable)) + geom_bar(stat="identity") + scale_x_continuous(labels=scales::percent_format(accuracy=1)) + labs(fill="", x="Share of student loan borrowers in California", y="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Spectral") 
...
g21B <- ggplot(data=tblCreditScore.US.Borrow, mapping=aes(y=Race, x=`Share`, fill=variable)) + geom_bar(stat="identity") + scale_x_continuous(labels=scales::percent_format(accuracy=1)) + labs(fill="", x="Share of student loan borrowers in rest of U.S.", y="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Spectral") 
...
g21C <- ggplot(data=tblCreditScore.CA.Nonborrow, mapping=aes(y=Race, x=`Share`, fill=variable)) + geom_bar(stat="identity") + scale_x_continuous(labels=scales::percent_format(accuracy=1)) + labs(fill="", x="Share of non-borrowers in California", y="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Spectral") 
...
The survey years included for Figure 21 are
...
g22A <- ggplot(data=tblPayBills.CA.Borrow, mapping=aes(y=Race, x=`Share`, fill=variable)) + geom_bar(stat="identity") + scale_x_continuous(labels=scales::percent_format(accuracy=1)) + labs(fill="", x="Share of student loan borrowers in California", y="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Set2") 
...
g22B <- ggplot(data=tblPayBills.US.Borrow, mapping=aes(y=Race, x=`Share`, fill=variable)) + geom_bar(stat="identity") + scale_x_continuous(labels=scales::percent_format(accuracy=1)) + labs(fill="", x="Share of student loan borrowers in rest of U.S.", y="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Set2") 
...
g22C <- ggplot(data=tblPayBills.CA.Nonborrow, mapping=aes(y=Race, x=`Share`, fill=variable)) + geom_bar(stat="identity") + scale_x_continuous(labels=scales::percent_format(accuracy=1)) + labs(fill="", x="Share of non-borrowers in California", y="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Set2") 
...
The survey years included for Figure 22 are
...
ggplotly(g23B, width=800, height=350)
...
The survey years included for "Figure 23: Ability to pay student loan bill" are
```{r PartialSL.SY, results = 'asis'}
survey_years(shed.PartialSL$SurveyYear)
```

The survey years included for "Figure 23: Ability to pay rent or mortgage bill" are
```{r PartialRent.SY, results = 'asis'}
survey_years(shed.PartialRent$SurveyYear)
```

The survey years included for "Figure 23: Ability to pay credit card bill" are
```{r PartialCC.SY, results = 'asis'}
survey_years(shed.PartialCC$SurveyYear)
```
...
```{r figure24}
g24 <- ggplot(data=tblPartialSL400, mapping=aes(y=Race, x=`Share of borrowers who would skip paying, or make only a partial payment on, their student loan bill if they had a $400 emergency expense`, fill=State)) + geom_bar(stat="identity", position="dodge", width=0.7) + scale_x_continuous(labels=scales::percent_format(accuracy=1)) + labs(y="", title="", x="Share of borrowers who would not fully pay student loan bill") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Dark2")

ggplotly(g24, height=350)
...
The survey years included for Figure 24 are
```{r PartialSL400.SY, results = 'asis'}
survey_years(shed.PartialSL400$SurveyYear)
```

Limited to those who have student loans. Survey years 2020 and 2021 not included due to the federal student loan repayment pause. 
...
g25A <- ggplot(data=tblPayBills400.CA.Borrow, mapping=aes(y=Race, x=`Share`, fill=variable)) + geom_bar(stat="identity") + scale_x_continuous(labels=scales::percent_format(accuracy=1)) + labs(fill="", x="Share of student loan borrowers in California", y="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Set2") 
...
g25B <- ggplot(data=tblPayBills400.US.Borrow, mapping=aes(y=Race, x=`Share`, fill=variable)) + geom_bar(stat="identity") + scale_x_continuous(labels=scales::percent_format(accuracy=1)) + labs(fill="", x="Share of student loan borrowers in rest of U.S.", y="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Set2") 
...
g25C <- ggplot(data=tblPayBills400.CA.Nonborrow, mapping=aes(y=Race, x=`Share`, fill=variable)) + geom_bar(stat="identity") + scale_x_continuous(labels=scales::percent_format(accuracy=1)) + labs(fill="", x="Share of non-borrowers in California", y="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Set2") 
...
The survey years included for Figure 25 are
...
g26A <- ggplot(data=tblCCApprov.CA.Borrow, mapping=aes(y=Race, x=`Share`, fill=variable)) + geom_bar(stat="identity") + scale_x_continuous(labels=scales::percent_format(accuracy=1)) + labs(fill="", x="Share of student loan borrowers in California", y="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Set2") 

ggplotly(g26A, width=800, height=350)
...
g26B <- ggplot(data=tblCCApprov.US.Borrow, mapping=aes(y=Race, x=`Share`, fill=variable)) + geom_bar(stat="identity") + scale_x_continuous(labels=scales::percent_format(accuracy=1)) + labs(fill="", x="Share of student loan borrowers in rest of U.S.", y="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Set2") 

ggplotly(g26B, width=800, height=350)
...
The survey years included for Figure 26 are
...
The survey years included for Figure 27 are
...
```{r figure28D}
g28D <- ggplot(data=tblSNAP, mapping=aes(y=Race, x=`Share`, fill=Group)) + geom_bar(stat="identity", position="dodge", width=0.7) + scale_x_continuous(labels=scales::percent_format(accuracy=1), limits=c(0, 1)) + labs(y="", title="", x="Share who received SNAP") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Dark2") 

ggplotly(g28D, width=800, height=350)
...
The survey years included for "Figure 28: Social Security" are
```{r SocSec.SY, results = 'asis'}
survey_years(shed.SocSec$SurveyYear)
```

The survey years included for "Figure 28: Cash assistance" are
```{r Welfare.SY, results = 'asis'}
survey_years(shed.Welfare$SurveyYear)
```

The survey years included for "Figure 28: EITC" are
```{r EITC.SY, results = 'asis'}
survey_years(shed.EITC$SurveyYear)
```

The survey years included for "Figure 28: SNAP" are
```{r SNAP.SY, results = 'asis'}
survey_years(shed.SNAP$SurveyYear)
```

The survey years included for "Figure 28: Housing assistance" are
```{r HouseAssist.SY, results = 'asis'}
survey_years(shed.HouseAssist$SurveyYear)
```

The survey years included for "Figure 28: Free or reduced price lunch" are
```{r FRPL.SY, results = 'asis'}
survey_years(shed.FRPL$SurveyYear)
```
...
# table(shed$ThreeMonSave)
shed.ThreeMonSave <- shed %>% filter((ThreeMonSave %in% c("Refused", "Not In Universe (not asked)", "", NA)==FALSE)) 
...
# table(shed$ThreeMonCover)
shed.ThreeMonCover <- shed %>% filter((ThreeMonCover %in% c("Refused", "Not In Universe (not asked)", "", NA)==FALSE)) 
...
The survey years included for "Figure 29: Cover expenses with savings" are
```{r ThreeMonSave.SY, results = 'asis'}
survey_years(shed.ThreeMonSave$SurveyYear)
```

The survey years included for "Figure 29: Cover expenses by any means" are
```{r ThreeMonCover.SY, results = 'asis'}
survey_years(shed.ThreeMonCover$SurveyYear)
```

```{r ThreeMonSave.N}
N.ThreeMonSave <- aggregate(data=shed.ThreeMonSave, Count ~ Race + State + AnyStudentLoans, FUN=sum)
N.ThreeMonSave <- N.ThreeMonSave %>% filter(State=="CA" | AnyStudentLoans=="Yes")
names(N.ThreeMonSave) <- c("Group", "State", "Student loan borrower", "Survey respondents")
kable(N.ThreeMonSave, caption="N size by group for Figure 29: Cover expenses with savings") %>% kable_paper("hover", full_width = F)
```

```{r ThreeMonCover.N}
N.ThreeMonCover <- aggregate(data=shed.ThreeMonCover, Count ~ Race + State + AnyStudentLoans, FUN=sum)
N.ThreeMonCover <- N.ThreeMonCover %>% filter(State=="CA" | AnyStudentLoans=="Yes")
names(N.ThreeMonCover) <- c("Group", "State", "Student loan borrower", "Survey respondents")
kable(N.ThreeMonCover, caption="N size by group for Figure 29: Cover expenses by any means") %>% kable_paper("hover", full_width = F)
```
...
ggplotly(g30F, width=800, height=350)
...
The survey years included for Figure 30 are
...
g31A <- ggplot(data=tblEdPayoff1.CA.Borrow, mapping=aes(y=Race, x=`Share`, fill=variable)) + geom_bar(stat="identity") + scale_x_continuous(labels=scales::percent_format(accuracy=1)) + labs(fill="", x="Share of student loan borrowers in California", y="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Spectral") 
...
g31B <- ggplot(data=tblEdPayoff1.US.Borrow, mapping=aes(y=Race, x=`Share`, fill=variable)) + geom_bar(stat="identity") + scale_x_continuous(labels=scales::percent_format(accuracy=1)) + labs(fill="", x="Share of student loan borrowers in rest of U.S.", y="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Spectral") 
...
g31C <- ggplot(data=tblEdPayoff1.CA.Nonborrow, mapping=aes(y=Race, x=`Share`, fill=variable)) + geom_bar(stat="identity") + scale_x_continuous(labels=scales::percent_format(accuracy=1)) + labs(fill="", x="Share of non-borrowers in California", y="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Spectral") 
...
The survey years included for Figure 31 are
...
The survey years included for "Figure 32: Different field" are
```{r DiffField1.SY, results = 'asis'}
survey_years(shed.DiffField1$SurveyYear)
```

The survey years included for "Figure 32: Different school" are
```{r DiffSchool1.SY, results = 'asis'}
survey_years(shed.DiffSchool1$SurveyYear)
```

The survey years included for "Figure 32: Less education" are
```{r LessEd1.SY, results = 'asis'}
survey_years(shed.LessEd1$SurveyYear)
```

The survey years included for "Figure 32: More education" are
```{r MoreEd1.SY, results = 'asis'}
survey_years(shed.MoreEd1$SurveyYear)
```

Interpret the "California student loan borrowers" results with caution due to small sample size. 
...
ggplotly(g33, width=800, height=350)
...
The survey years included for Figure 33 are
...
g34A <- ggplot(data=tblInstLevel.CA.Borrow, mapping=aes(y=Race, x=`Share`, fill=variable)) + geom_bar(stat="identity") + scale_x_continuous(labels=scales::percent_format(accuracy=1)) + labs(fill="", x="Share of student loan borrowers in California", y="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Set2") 
...
g34B <- ggplot(data=tblInstLevel.US.Borrow, mapping=aes(y=Race, x=`Share`, fill=variable)) + geom_bar(stat="identity") + scale_x_continuous(labels=scales::percent_format(accuracy=1)) + labs(fill="", x="Share of student loan borrowers in rest of U.S.", y="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Set2") 
...
g34C <- ggplot(data=tblInstLevel.CA.Nonborrow, mapping=aes(y=Race, x=`Share`, fill=variable)) + geom_bar(stat="identity") + scale_x_continuous(labels=scales::percent_format(accuracy=1)) + labs(fill="", x="Share of non-borrowers in California", y="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Set2") 
...
The survey years included for Figure 34 are
...
g35A <- ggplot(data=tblInstControl.CA.Borrow, mapping=aes(y=Race, x=`Share`, fill=variable)) + geom_bar(stat="identity") + scale_x_continuous(labels=scales::percent_format(accuracy=1)) + labs(fill="", x="Share of student loan borrowers in California", y="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Set2") 

ggplotly(g35A, width=800, height=350)
...
g35B <- ggplot(data=tblInstControl.US.Borrow, mapping=aes(y=Race, x=`Share`, fill=variable)) + geom_bar(stat="identity") + scale_x_continuous(labels=scales::percent_format(accuracy=1)) + labs(fill="", x="Share of student loan borrowers in rest of U.S.", y="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Set2") 

ggplotly(g35B, width=800, height=350)
...
g35C <- ggplot(data=tblInstControl.CA.Nonborrow, mapping=aes(y=Race, x=`Share`, fill=variable)) + geom_bar(stat="identity") + scale_x_continuous(labels=scales::percent_format(accuracy=1)) + labs(fill="", x="Share of non-borrowers in California", y="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Set2") 

ggplotly(g35C, width=800, height=350)
...
The survey years included for Figure 35 are
...
```{r figure36A}
g36A <- ggplot(data=Q26.Bplot, mapping=aes(x=`Rank of BKAA share`, y=`Rank of weighted earnings`)) + geom_point(stat="identity") + facet_wrap(`CREDDESC` ~ .) + labs(x="Rank of Black share of completers", y="Rank of earnings among completers") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Set2") 
...
```{r figure36B}
g36B <- ggplot(data=Q26.Hplot, mapping=aes(x=`Rank of HISP share`, y=`Rank of weighted earnings`)) + geom_point(stat="identity") + facet_wrap(`CREDDESC` ~ .) + labs(x="Rank of Hispanic share of completers", y="Rank of earnings among completers") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Set2") 
...
```{r figure37A}
g37A <- ggplot(data=Q27.Bplot, mapping=aes(x=`Rank of BKAA share`, y=`Rank of weighted debt`)) + geom_point(stat="identity") + facet_wrap(`CREDDESC` ~ .) + labs(x="Rank of Black share of completers", y="Rank of debt among completers") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Set2") 

ggplotly(g37A, width=800, height=600)
