...
kable(N.DiffField, caption="N size by group for Figure 31") %>% kable_paper("hover", full_width = F)
```
...
kable(N.DiffSchool, caption="N size by group for Figure 31") %>% kable_paper("hover", full_width = F)
```
