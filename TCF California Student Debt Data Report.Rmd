...
kable(interstateComp, caption="Table X: California's rank on average debt measures")
```
...
kable(scaleCali, caption="Table X: Size of California borrowers' outstanding debt")
```
...
kable(table3.1, caption="Table X: Share of loan dollars disbursed in 2018-19 by loan type, California vs. U.S.")
```
...
This comes after the tabset ... right?
