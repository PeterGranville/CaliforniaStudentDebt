---
title: "What the Data Tell Us About Student Debt in California"
...
pusa <- fread("psam2021_pusa.csv", header=TRUE, select=c("SERIALNO", "ST", "AGEP", "PWGTP"))
pusb <- fread("psam2021_pusb.csv", header=TRUE, select=c("SERIALNO", "ST", "AGEP", "PWGTP"))
...
write.csv(ranksChart1, "california-figure1-data.csv", row.names=FALSE)
```
...
write.csv(ranksChart2, "california-figure2-data.csv", row.names=FALSE)
```
...
loans2122 <- fread("dl-dashboard-ay2021-2022-q4-california.csv", header=TRUE, skip=6)
...
loans2122$State[loans2122$`OPEID` == 188100] <- "Rest of U.S."
...
loans2122$OPEID <- as.character(loans2122$OPEID)
loans2122$OPEID <- ifelse(nchar(loans2122$OPEID)==1, paste("0", loans2122$OPEID, sep=""), loans2122$OPEID)
loans2122$OPEID <- ifelse(nchar(loans2122$OPEID)==2, paste("0", loans2122$OPEID, sep=""), loans2122$OPEID)
loans2122$OPEID <- ifelse(nchar(loans2122$OPEID)==3, paste("0", loans2122$OPEID, sep=""), loans2122$OPEID)
loans2122$OPEID <- ifelse(nchar(loans2122$OPEID)==4, paste("0", loans2122$OPEID, sep=""), loans2122$OPEID)
loans2122$OPEID <- ifelse(nchar(loans2122$OPEID)==5, paste("0", loans2122$OPEID, sep=""), loans2122$OPEID)
loans2122$OPEID <- ifelse(nchar(loans2122$OPEID)==6, paste("0", loans2122$OPEID, sep=""), loans2122$OPEID)
loans2122$OPEID <- ifelse(nchar(loans2122$OPEID)==7, paste("0", loans2122$OPEID, sep=""), loans2122$OPEID)
...
loans2122$`SUBSIDIZED: Recipients` <- as.numeric(loans2122$`SUBSIDIZED: Recipients`)
loans2122$`SUBSIDIZED: $ of Disbursements` <- as.numeric(loans2122$`SUBSIDIZED: $ of Disbursements`)
   
loans2122$`UNSUBSIDIZED - UNDERGRADUATE: Recipients` <- as.numeric(loans2122$`UNSUBSIDIZED - UNDERGRADUATE: Recipients`)
loans2122$`UNSUBSIDIZED - UNDERGRADUATE: $ of Disbursements` <- as.numeric(loans2122$`UNSUBSIDIZED - UNDERGRADUATE: $ of Disbursements`)

loans2122$`UNSUBSIDIZED - GRADUATE: Recipients` <- as.numeric(loans2122$`UNSUBSIDIZED - GRADUATE: Recipients`)
loans2122$`UNSUBSIDIZED - GRADUATE: $ of Disbursements` <- as.numeric(loans2122$`UNSUBSIDIZED - GRADUATE: $ of Disbursements`)

loans2122$`PARENT PLUS: Recipients` <- as.numeric(loans2122$`PARENT PLUS: Recipients`)
loans2122$`PARENT PLUS: $ of Disbursements` <- as.numeric(loans2122$`PARENT PLUS: $ of Disbursements`)

loans2122$`GRAD PLUS: Recipients` <- as.numeric(loans2122$`GRAD PLUS: Recipients`)
loans2122$`GRAD PLUS: $ of Disbursements` <- as.numeric(loans2122$`GRAD PLUS: $ of Disbursements`)
...
loans2122$`SUBSIDIZED: Recipients`[is.na(loans2122$`SUBSIDIZED: Recipients`)] <- 0
loans2122$`SUBSIDIZED: $ of Disbursements`[is.na(loans2122$`SUBSIDIZED: $ of Disbursements`)] <- 0
   
loans2122$`UNSUBSIDIZED - UNDERGRADUATE: Recipients`[is.na(loans2122$`UNSUBSIDIZED - UNDERGRADUATE: Recipients`)] <- 0
loans2122$`UNSUBSIDIZED - UNDERGRADUATE: $ of Disbursements`[is.na(loans2122$`UNSUBSIDIZED - UNDERGRADUATE: $ of Disbursements`)] <- 0

loans2122$`UNSUBSIDIZED - GRADUATE: Recipients`[is.na(loans2122$`UNSUBSIDIZED - GRADUATE: Recipients`)] <- 0
loans2122$`UNSUBSIDIZED - GRADUATE: $ of Disbursements`[is.na(loans2122$`UNSUBSIDIZED - GRADUATE: $ of Disbursements`)] <- 0

loans2122$`PARENT PLUS: Recipients`[is.na(loans2122$`PARENT PLUS: Recipients`)] <- 0
loans2122$`PARENT PLUS: $ of Disbursements`[is.na(loans2122$`PARENT PLUS: $ of Disbursements`)] <- 0

loans2122$`GRAD PLUS: Recipients`[is.na(loans2122$`GRAD PLUS: Recipients`)] <- 0
loans2122$`GRAD PLUS: $ of Disbursements`[is.na(loans2122$`GRAD PLUS: $ of Disbursements`)] <- 0

loans2122$`Total $ of Disbursements` <- loans2122$`SUBSIDIZED: $ of Disbursements` + loans2122$`UNSUBSIDIZED - UNDERGRADUATE: $ of Disbursements` + loans2122$`UNSUBSIDIZED - GRADUATE: $ of Disbursements` + loans2122$`PARENT PLUS: $ of Disbursements` + loans2122$`GRAD PLUS: $ of Disbursements`

loans2122$`Total $ of Undergraduate Disbursements` <- loans2122$`SUBSIDIZED: $ of Disbursements` + loans2122$`UNSUBSIDIZED - UNDERGRADUATE: $ of Disbursements` + loans2122$`PARENT PLUS: $ of Disbursements`
...
table3.1 <- aggregate(data=table3.1, cbind(  
  ...
  `Total $ of Undergraduate Disbursements`) ~ State, FUN=sum)
...
table3.2 <- table3.2 %>% add_row(
  ...
  "Total $ of Undergraduate Disbursements" = sum(table3.2$`Total $ of Undergraduate Disbursements`)
)
...
table3.1A$`SUBSIDIZED share of total` <- table3.1A$`SUBSIDIZED: $ of Disbursements` / table3.1A$`Total $ of Disbursements`
table3.1A$`UNSUBSIDIZED - UNDERGRADUATE share of total` <- table3.1A$`UNSUBSIDIZED - UNDERGRADUATE: $ of Disbursements` / table3.1A$`Total $ of Disbursements`
table3.1A$`UNSUBSIDIZED - GRADUATE share of total` <- table3.1A$`UNSUBSIDIZED - GRADUATE: $ of Disbursements` / table3.1A$`Total $ of Disbursements`
table3.1A$`PARENT PLUS share of total` <- table3.1A$`PARENT PLUS: $ of Disbursements` / table3.1A$`Total $ of Disbursements`
table3.1A$`GRAD PLUS share of total` <- table3.1A$`GRAD PLUS: $ of Disbursements` / table3.1A$`Total $ of Disbursements`

table3.1B$`SUBSIDIZED share of total` <- table3.1B$`SUBSIDIZED: $ of Disbursements` / table3.1B$`Total $ of Undergraduate Disbursements`
table3.1B$`UNSUBSIDIZED - UNDERGRADUATE share of total` <- table3.1B$`UNSUBSIDIZED - UNDERGRADUATE: $ of Disbursements` / table3.1B$`Total $ of Undergraduate Disbursements`
table3.1B$`PARENT PLUS share of total` <- table3.1B$`PARENT PLUS: $ of Disbursements` / table3.1B$`Total $ of Undergraduate Disbursements`
...
table3.1A <- table3.1A %>% filter(State %in% c("CA", "Rest of U.S.")) %>% select(State, `SUBSIDIZED share of total`, `UNSUBSIDIZED - UNDERGRADUATE share of total`, `UNSUBSIDIZED - GRADUATE share of total`, `PARENT PLUS share of total`, `GRAD PLUS share of total`)
names(table3.1A) <- c("State", "Subsidized", "Unsubsidized undergraduate", "Unsubsidized graduate", "Parent PLUS loans", "Grad PLUS")
table3.1A$`Subsidized` <- percent(table3.1A$`Subsidized`, accuracy=0.1)
table3.1A$`Unsubsidized undergraduate` <- percent(table3.1A$`Unsubsidized undergraduate`, accuracy=0.1)
table3.1A$`Unsubsidized graduate` <- percent(table3.1A$`Unsubsidized graduate`, accuracy=0.1)
table3.1A$`Parent PLUS loans` <- percent(table3.1A$`Parent PLUS loans`, accuracy=0.1)
table3.1A$`Grad PLUS` <- percent(table3.1A$`Grad PLUS`, accuracy=0.1)

table3.1B <- table3.1B %>% filter(State %in% c("CA", "Rest of U.S.")) %>% select(State, `SUBSIDIZED share of total`, `UNSUBSIDIZED - UNDERGRADUATE share of total`, `PARENT PLUS share of total`)
names(table3.1B) <- c("State", "Subsidized", "Unsubsidized undergraduate", "Parent PLUS loans")
table3.1B$`Subsidized` <- percent(table3.1B$`Subsidized`, accuracy=0.1)
table3.1B$`Unsubsidized undergraduate` <- percent(table3.1B$`Unsubsidized undergraduate`, accuracy=0.1)
table3.1B$`Parent PLUS loans` <- percent(table3.1B$`Parent PLUS loans`, accuracy=0.1)
...
##### Table 3
```{r kable3.1A}
kable(table3.1A, caption="Share of loan dollars disbursed in 2021-22 by loan type, California vs. Rest of U.S.") %>% kable_paper("hover", full_width = F)
```

```{r kable3.1B}
kable(table3.1B, caption="Share of loan undergraduate dollars disbursed in 2021-22 by loan type, California vs. Rest of U.S.") %>% kable_paper("hover", full_width = F)
```
##### Table 3: All states
```{r kable3.2}
kable(table3.2, caption="Share of loan dollars disbursed in 2021-22 by loan type") %>% kable_paper("hover", full_width = F)
```

##### Data Source and Notes

**Data source:** Federal Student Aid Data Center, spreadsheet on Direct Loan volume for Q4 2021-22, "Award year summary" tab, [available here](https://studentaid.gov/data-center/student/title-iv), accessed April 2023. 
...
# scorecard1 <- fread("Most-Recent-Cohorts-Institution-Apr2023.csv", header=TRUE, select=c(
...
loans2122$State[loans2122$State != "CA"] <- "Rest of U.S."
loans2122 <- left_join(x=loans2122, y=scorecard1, by="OPEID")
forTable4 <- loans2122 %>% filter(`Four-year`==1)
...
# CSI <- fread("Most-Recent-Cohorts-Institution-Apr2023.csv", header=TRUE, select=c(
...
# CSP <- fread("Most-Recent-Cohorts-Field-of-Study-Apr2023.csv", header=TRUE, select=c(
  # Basic information about institutions: 
  "UNITID",       # Unit ID for institution
...
Q6$LPSTAFFORD_CNT[is.na(Q6$LPSTAFFORD_CNT)] <- 0
Q6$LPSTAFFORD_AMT[is.na(Q6$LPSTAFFORD_AMT)] <- 0
Q6$LPPPLUS_CNT[is.na(Q6$LPPPLUS_CNT)] <- 0
Q6$LPPPLUS_AMT[is.na(Q6$LPPPLUS_AMT)] <- 0
Q6$LPGPLUS_CNT[is.na(Q6$LPGPLUS_CNT)] <- 0
Q6$LPGPLUS_AMT[is.na(Q6$LPGPLUS_AMT)] <- 0
...
Q6.TotalStaffordDebt <- Q6 %>% arrange(desc(`Average outstanding Stafford debt`)) %>% filter(LPSTAFFORD_CNT >= 500) %>% select(OPEID6, INSTNM, CONTROL, LPSTAFFORD_AMT, LPSTAFFORD_CNT, `Average outstanding Stafford debt`)
Q6.TotalParentDebt <- Q6 %>% arrange(desc(`Average outstanding Parent PLUS debt`)) %>% filter(LPPPLUS_CNT >= 500) %>% select(OPEID6, INSTNM, CONTROL, LPPPLUS_AMT, LPPPLUS_CNT, `Average outstanding Parent PLUS debt`)
Q6.TotalGradDebt <- Q6 %>% arrange(desc(`Average outstanding Grad PLUS debt`)) %>% filter(LPGPLUS_CNT >= 500) %>% select(OPEID6, INSTNM, CONTROL, LPGPLUS_AMT, LPGPLUS_CNT, `Average outstanding Grad PLUS debt`)
Q6.TotalDebt <- Q6 %>% filter((OPEID6 %in% Institutions.Based.At.Least.Partially.Outside.CA)==FALSE) %>% arrange(desc(`Total outstanding debt`)) %>% select(OPEID6, INSTNM, CONTROL, `Total outstanding debt`)
...
write.csv(kable4C, "kable4C.csv", row.names=FALSE)
```
#### Table 4: Total debt
...
Table 8 is the first to look at long-term debt repayment. When a student borrows, are they able to pay down the balance or do those balances rise as interest accumulates? The data in this table reflect the cohort of borrowers who entered repayment in 2008-09, and it compares the cohort's original total balance with their balance at the ten-year mark of repayment. For example, a ratio of 0.7 would mean that the current total balance is 70 percent of the original total balance. A ratio above 1 indicates that the cohort is struggling to even keep up with interest payments. These data are broken out between Stafford undergraduate loans, Parent PLUS loans, and graduate loans (Grad PLUS and Stafford graduate loans). 

Some colleges near the top of the list for Stafford undergraduate loans are, in fact, California community colleges. The average outstanding balance 10 years into repayment is less than $15,000, but ratios about 1 indicate that this average is actually greater than the original average balance the borrowers had when they entered repayment. 
...
The table on graduate debt could be taken with a grain of salt since those in the medical and law fields often start with very high debt amounts and take years to build up their incomes to start repaying. However, the fact that some ratios are as high as 1.2 is concerning: this means the typical borrower owes 20 percent more after ten years than they did at the start of repayment. Four schools raise flags for high ratios and high average graduate debt amounts: Life Chiropractic College West, Southern California University of Health Sciences, American Film Institute Conservatory, and Thomas Jefferson School of Law. 
...
```
#### Table 8: Stafford undergraduate loans
...
```
#### Table 8: Graduate loans
```{r kable8C, results='asis'}
kable8C <- Q21.G %>% select(INSTNM, CONTROL, `Repayment ratio`, `Average balance after ten years in repayment`)
names(kable8C) <- c("Institution name", "Control of institution", "Ratio of current graduate loan balance to original balance, 10 years into repayment", "Average outstanding graduate debt, 10 years into repayment")
kable(kable8C, caption="California institutions by ratio of graduate loan borrowers' current balance to original balance, 10 years into repayment") %>% kable_paper("hover", full_width = F) %>% scroll_box(width = "100%", height = "400px")
```
#### Data Source and Notes
...
Table 9 uses data on the status of borrowers three years into repayment and asks how many are in default, delinquent, or otherwise not making progress to reduce the principal of those loans. As noted above, the federal student loan payment pause and forbearance period do not affect this measure. These data are broken out between Stafford undergraduate loans, Parent PLUS loans, and graduate loans (Grad PLUS and Stafford graduate loans).

Here we see for-profit trade schools high on the list for Stafford undergraduate loans, even though the students who attend them often have small loan amounts. At some colleges, half of all Stafford undergraduate borrowers are behind on payments three years into repayment. The percentages for Parent PLUS are not as high, although some are above one-third. The colleges at the top of the list for graduate loans include some arts colleges and health sciences college.
...
```
#### Table 9: Stafford undergraduate loans
...
write.csv(kable9A, "kable9A.csv", row.names=FALSE)
```
#### Table 9: Parent PLUS loans
...
write.csv(kable9B, "kable9B.csv", row.names=FALSE)
```
#### Table 9: Graduate borrowers
```{r kable9C, results='asis'}
kable9C <- Q22.G %>% select(INSTNM, CONTROL, `Default delinquent or not making progress`)
names(kable9C) <- c("Institution name", "Control of institution", "Estimated share of graduate loan borrowers who are in default, delinquent, or not making progress three years into repayment")
kable(kable9C, caption="California institutions by share of graduate loan borrowers who are in default, delinquent, or not making progress three years into repayment") %>% kable_paper("hover", full_width = F) %>% scroll_box(width = "100%", height = "400px")
write.csv(kable9C, "kable9C.csv", row.names=FALSE)
```
#### Data Source and Notes
...
**Notes:** I applied a threshold of minimum 200 borrowers per institution. These percentages do not include those in forbearance or deferment. Percentages rounded to nearest 0.1%. 
...
In the College Scorecard, DBRR data are reported at the institution level and disaggregated by loan type (Stafford undergraduate loans, Parent PLUS loans, and graduate loans). I aggregated the DBRR values across all institutions with sufficient data and compared institutions in California to institutions in the rest of the U.S., with breakouts by institutional control and loan type. 
...
# CSI2 <- fread("Most-Recent-Cohorts-Institution-Apr2023.csv", header=TRUE, select=c(
  # Basic information about institutions: 
  "UNITID",       # Unit ID for institution
  "OPEID",        # 8-digit OPEID
  "OPEID6",       # 6-digit OPEID
...
CSI2$STABBR[CSI2$`OPEID` == 188100] <- "Ashford" # Coding Ashford University as not in California
...
Q28$Program[grepl("_FED_UG_", Q28$variable)] <- "Stafford undergraduate loans"
Q28$Program[grepl("_FED_GR_", Q28$variable)] <- "Graduate loans"
...
placehold.DF <- data.frame("State"=c(rep("California", 12), rep("Rest of U.S.", 12)), 
                           ...
                           "Program"=rep(c("Stafford undergraduate loans", "Graduate loans", "Parent PLUS"), 8), 
                           "Year"=rep(0, 24), 
...
Q28.S <- Q28 %>% filter(Program=="Stafford undergraduate loans")
Q28.G <- Q28 %>% filter(Program=="Graduate loans")
Q28.P <- Q28 %>% filter(Program=="Parent PLUS")
```
#### Figure 36: Stafford undergraduate loans
```{r figure36A}
...
Figure 37 shows the average current loan amount for four cohorts, organized by institutional control and loan type, comparing California institutions to those in the rest of the U.S. In the first tab, we see that average Stafford undergraduate loan amounts are lower among borrowers from California institutions than those from institutions across the rest of the U.S., driven by lower average loans at California's public institutions. 
...
Looking now to graduate loans, we see similar trends. Borrowers from California's private colleges have higher average graduate loans than those from non-California private colleges, especially for-profits. For the 5-year cohort, average graduate loans for borrowers from California nonprofits are 29 percent higher than those for borrowers from non-California nonprofits. In the same cohort, average graduate loans for borrowers from California for-profits are 38 percent higher than those for borrowers from non-California for-profits. On the bright side, average graduate loans from California's public colleges are lower than average graduate loans from non-California public colleges, across all four cohorts. 
...
```
#### Figure 37: Stafford undergraduate loans
```{r figure37A}
...
Ashford University has been recoded as a non-California institution for the purpose of this analysis. 

***

### {-}

Taken together, figures 36 and 37 show that borrowers from California's colleges and universities make similar or better progress on repayment compared to borrowers from colleges and universities across the rest of the U.S. However, for borrowers with Parent PLUS and graduate loans, average loan balances tend to be higher when they are for enrollment in California institutions, and it takes those borrowers even longer to bring down those balances. 

Consider that, for borrowers with graduate loans from a California for-profit college, the average loan of those who have been in repayment for 20 years is roughly $27,800. That means, for the typical borrower with graduate loans for a California for-profit, even 20 years is not enough to get the balance below \$20,000. Graduate borrowers from for-profits outside California owe an average of \$8,618 after 20 years in repayment. 
...
# CSI3 <- fread("Most-Recent-Cohorts-Institution-Apr2023.csv", header=TRUE, select=c(
  # Basic information about institutions: 
  "UNITID",       # Unit ID for institution
  "OPEID",        # 8-digit OPEID
  "OPEID6",       # 6-digit OPEID
...
pc.n1 <- N.OwnDebtTotal$`Survey respondents`[(N.OwnDebtTotal$State=="CA") & (N.OwnDebtTotal$Group=="Hispanic")]
pc.n2 <- N.OwnDebtTotal$`Survey respondents`[(N.OwnDebtTotal$State=="CA") & (N.OwnDebtTotal$Group=="White, Non-Hispanic")]
...
# Figure 12
# Code ChildDebt
# Share who hold debt for a child or grandchild's education 
# Hispanic households in CA vs. white households in CA 
pc.n1 <- N.ChildDebt$`Survey respondents`[(N.ChildDebt$State=="CA") & (N.ChildDebt$Group=="Hispanic")]
pc.n2 <- N.ChildDebt$`Survey respondents`[(N.ChildDebt$State=="CA") & (N.ChildDebt$Group=="White, Non-Hispanic")]
pc.p1 <- tblChildDebt$`Share who have debt for a child's or grandchild's education`[(tblChildDebt$State=="CA") & (tblChildDebt$Race=="Hispanic")]
pc.p2 <- tblChildDebt$`Share who have debt for a child's or grandchild's education`[(tblChildDebt$State=="CA") & (tblChildDebt$Race=="White, Non-Hispanic")]
power.SHED <- power.SHED %>% add_row(
  `Measure`="Share with debt for a child or grandchild's education", 
  `Figure`="Figure 12", 
  `Group 1`="Hispanic households in CA",
  `Group 2`="White households in CA", 
  `N1`=pc.n1, `N2`=pc.n2, `P1`=percent(pc.p1, accuracy=0.1), `P2`=percent(pc.p2, accuracy=0.1), `Difference`= percent((pc.p1 - pc.p2), accuracy=0.1), 
...
pc.n1 <- N.EdAttain1$`Survey respondents`[(N.EdAttain1$State=="CA") & (N.EdAttain1$Group=="Hispanic") & (N.EdAttain1$`Student loan borrower`=="Yes")]
pc.n2 <- N.EdAttain1$`Survey respondents`[(N.EdAttain1$State=="CA") & (N.EdAttain1$Group=="White, Non-Hispanic") & (N.EdAttain1$`Student loan borrower`=="Yes")]
pc.p1 <- tblEdAttain2$`No college degree`[(tblEdAttain2$State=="CA") & (tblEdAttain2$Race=="Hispanic") & (tblEdAttain2$AnyStudentLoans=="Yes")]
pc.p2 <- tblEdAttain2$`No college degree`[(tblEdAttain2$State=="CA") & (tblEdAttain2$Race=="White, Non-Hispanic") & (tblEdAttain2$AnyStudentLoans=="Yes")]
power.SHED <- power.SHED %>% add_row(
...
pc.n1 <- N.HomeOwn$`Survey respondents`[(N.HomeOwn$State=="CA") & (N.HomeOwn$Group=="Black, Non-Hispanic") & (N.HomeOwn$`Student loan borrower`=="Yes")]
pc.n2 <- N.HomeOwn$`Survey respondents`[(N.HomeOwn$State=="Rest of U.S.") & (N.HomeOwn$Group=="Black, Non-Hispanic") & (N.HomeOwn$`Student loan borrower`=="Yes")]
...
power.SHED <- power.SHED %>% add_row(
  ...
  `Group 2`="Black borrowers in rest of U.S.", 
  `N1`=pc.n1, `N2`=pc.n2, `P1`=percent(pc.p1, accuracy=0.1), `P2`=percent(pc.p2, accuracy=0.1), `Difference`= percent((pc.p1 - pc.p2), accuracy=0.1), 
  `Power`=pwr.2p2n.test(n1 = pc.n1, n2 = pc.n2, h = (pc.p1 - pc.p2), sig.level=0.05, alternative="less")$power
)
rm("pc.n1", "pc.n2", "pc.p1", "pc.p2")
```
...
# Black borrowers in CA vs. white borrowers in CA 
pc.n1 <- N.HomeOwn$`Survey respondents`[(N.HomeOwn$State=="CA") & (N.HomeOwn$Group=="Black, Non-Hispanic") & (N.HomeOwn$`Student loan borrower`=="Yes")]
pc.n2 <- N.HomeOwn$`Survey respondents`[(N.HomeOwn$State=="CA") & (N.HomeOwn$Group=="White, Non-Hispanic") & (N.HomeOwn$`Student loan borrower`=="Yes")]
pc.p1 <- tblHomeOwn2$`Own home`[(tblHomeOwn2$State=="CA") & (tblHomeOwn2$Race=="Black, Non-Hispanic") & (tblHomeOwn2$AnyStudentLoans=="Yes")]
...
pc.n1 <- N.CCBalance$`Survey respondents`[(N.CCBalance$State=="CA") & (N.CCBalance$Group=="Black, Non-Hispanic") & (N.CCBalance$`Student loan borrower`=="Yes")]
pc.n2 <- N.CCBalance$`Survey respondents`[(N.CCBalance$State=="CA") & (N.CCBalance$Group=="White, Non-Hispanic") & (N.CCBalance$`Student loan borrower`=="Yes")]
...
# Share who carry an unpaid credit card balance at least "some of the time" 
# Hispanic borrowers in CA vs. white borrowers in CA
pc.n1 <- N.CCBalance$`Survey respondents`[(N.CCBalance$State=="CA") & (N.CCBalance$Group=="Hispanic") & (N.CCBalance$`Student loan borrower`=="Yes")]
pc.n2 <- N.CCBalance$`Survey respondents`[(N.CCBalance$State=="CA") & (N.CCBalance$Group=="White, Non-Hispanic") & (N.CCBalance$`Student loan borrower`=="Yes")]
...
# Share who carry an unpaid credit card balance at least "some of the time" 
# Black and Hispanic borrowers in CA vs. white borrowers in CA  
pc.m1 <- N.CCBalance$`Survey respondents`[(N.CCBalance$State=="CA") & (N.CCBalance$Group=="Black, Non-Hispanic") & (N.CCBalance$`Student loan borrower`=="Yes")]
pc.m2 <- N.CCBalance$`Survey respondents`[(N.CCBalance$State=="CA") & (N.CCBalance$Group=="Hispanic") & (N.CCBalance$`Student loan borrower`=="Yes")]
pc.o1 <- tblCCBalance2$`At least some of the time`[(tblCCBalance2$State=="CA") & (tblCCBalance2$Race=="Black, Non-Hispanic") & (tblCCBalance2$AnyStudentLoans=="Yes")] 
pc.o2 <- tblCCBalance2$`At least some of the time`[(tblCCBalance2$State=="CA") & (tblCCBalance2$Race=="Hispanic") & (tblCCBalance2$AnyStudentLoans=="Yes")] 
pc.n1 <- pc.m1 + pc.m2
pc.n2 <- N.CCBalance$`Survey respondents`[(N.CCBalance$State=="CA") & (N.CCBalance$Group=="White, Non-Hispanic") & (N.CCBalance$`Student loan borrower`=="Yes")]
pc.p1 <- (pc.o1 * (pc.m1 / (pc.m1 + pc.m2))) + (pc.o2 * (pc.m2 / (pc.m1 + pc.m2)))
pc.p2 <- tblCCBalance2$`At least some of the time`[(tblCCBalance2$State=="CA") & (tblCCBalance2$Race=="White, Non-Hispanic") & (tblCCBalance2$AnyStudentLoans=="Yes")] 
...
pc.m1 <- N.Savings$`Survey respondents`[(N.Savings$State=="CA") & (N.Savings$Group=="Black, Non-Hispanic") & (N.Savings$`Student loan borrower`=="Yes")]
pc.m2 <- N.Savings$`Survey respondents`[(N.Savings$State=="CA") & (N.Savings$Group=="Hispanic") & (N.Savings$`Student loan borrower`=="Yes")]
pc.n1 <- pc.m1 + pc.m2
pc.n2 <- N.Savings$`Survey respondents`[(N.Savings$State=="CA") & (N.Savings$Group=="White, Non-Hispanic") & (N.Savings$`Student loan borrower`=="Yes")]
pc.p1 <- (pc.o1 * (pc.m1 / (pc.m1 + pc.m2))) + (pc.o2 * (pc.m2 / (pc.m1 + pc.m2)))
...
pc.n1 <- N.TotalInc$`Survey respondents`[(N.TotalInc$State=="CA") & (N.TotalInc$Group=="Hispanic") & (N.TotalInc$`Student loan borrower`=="Yes")]
pc.n2 <- N.TotalInc$`Survey respondents`[(N.TotalInc$State=="CA") & (N.TotalInc$Group=="White, Non-Hispanic") & (N.TotalInc$`Student loan borrower`=="Yes")]
...
# Share who earn under $75,000
# Black borrowers in CA vs. white borrowers in CA 
pc.n1 <- N.TotalInc$`Survey respondents`[(N.TotalInc$State=="CA") & (N.TotalInc$Group=="Black, Non-Hispanic") & (N.TotalInc$`Student loan borrower`=="Yes")]
pc.n2 <- N.TotalInc$`Survey respondents`[(N.TotalInc$State=="CA") & (N.TotalInc$Group=="White, Non-Hispanic") & (N.TotalInc$`Student loan borrower`=="Yes")]
...
pc.m1 <- N.TotalInc$`Survey respondents`[(N.TotalInc$State=="CA") & (N.TotalInc$Group=="Black, Non-Hispanic") & (N.TotalInc$`Student loan borrower`=="Yes")]
pc.m2 <- N.TotalInc$`Survey respondents`[(N.TotalInc$State=="CA") & (N.TotalInc$Group=="Hispanic") & (N.TotalInc$`Student loan borrower`=="Yes")]
pc.n1 <- pc.m1 + pc.m2
...
# Black borrowers in CA vs. white borrowers in CA
pc.n1 <- N.FinManage$`Survey respondents`[(N.FinManage$State=="CA") & (N.FinManage$Group=="Black, Non-Hispanic") & (N.FinManage$`Student loan borrower`=="Yes")]
pc.n2 <- N.FinManage$`Survey respondents`[(N.FinManage$State=="CA") & (N.FinManage$Group=="White, Non-Hispanic") & (N.FinManage$`Student loan borrower`=="Yes")]
...
pc.n1 <- N.CreditScore$`Survey respondents`[(N.CreditScore$State=="CA") & (N.CreditScore$Group=="Black, Non-Hispanic") & (N.CreditScore$`Student loan borrower`=="Yes")]
pc.n2 <- N.CreditScore$`Survey respondents`[(N.CreditScore$State=="CA") & (N.CreditScore$Group=="White, Non-Hispanic") & (N.CreditScore$`Student loan borrower`=="Yes")]
...
power.SHED <- power.SHED %>% add_row(
  `Measure`="Share who have a poor or very poor credit score", 
  `Figure`="Figure 21", 
  `Group 1`="Black borrowers in CA",
  `Group 2`="White borrowers in CA", 
  `N1`=pc.n1, `N2`=pc.n2, `P1`=percent(pc.p1, accuracy=0.1), `P2`=percent(pc.p2, accuracy=0.1), `Difference`= percent((pc.p1 - pc.p2), accuracy=0.1), 
...
# Black borrowers in CA vs. Black borrowers in rest of US 
pc.n1 <- N.CreditScore$`Survey respondents`[(N.CreditScore$State=="CA") & (N.CreditScore$Group=="Black, Non-Hispanic") & (N.CreditScore$`Student loan borrower`=="Yes")]
pc.n2 <- N.CreditScore$`Survey respondents`[(N.CreditScore$State=="Rest of U.S.") & (N.CreditScore$Group=="Black, Non-Hispanic") & (N.CreditScore$`Student loan borrower`=="Yes")]
pc.p1 <- tblCreditScore2$`Poor or very poor`[(tblCreditScore2$State=="CA") & (tblCreditScore2$Race=="Black, Non-Hispanic") & (tblCreditScore2$AnyStudentLoans=="Yes")]
...
pc.p1 <- tblPayBills3$`I cannot pay some bills or will only make a partial payment on them`[(tblPayBills3$State=="CA") & (tblPayBills3$`AnyStudentLoans`=="Yes")]
pc.p2 <- tblPayBills3$`I cannot pay some bills or will only make a partial payment on them`[(tblPayBills3$State=="CA") & (tblPayBills3$`AnyStudentLoans`=="No")]
power.SHED <- power.SHED %>% add_row(
...
# Black borrowers in CA vs. white borrowers in CA
pc.n1 <- N.ThreeMonExpenses$`Survey respondents`[(N.ThreeMonExpenses$State=="CA") & (N.ThreeMonExpenses$Group=="Black, Non-Hispanic") & (N.ThreeMonExpenses$`Student loan borrower`=="Yes")]
pc.n2 <- N.ThreeMonExpenses$`Survey respondents`[(N.ThreeMonExpenses$State=="CA") & (N.ThreeMonExpenses$Group=="White, Non-Hispanic") & (N.ThreeMonExpenses$`Student loan borrower`=="Yes")]
...
power.SHED <- power.SHED %>% add_row(
  `Measure`="Share who cannot replace 3 months of income using savings", 
  `Figure`="Figure 29", 
  `Group 1`="Black borrowers in CA",
  `Group 2`="White borrowers in CA", 
  `N1`=pc.n1, `N2`=pc.n2, `P1`=percent(pc.p1, accuracy=0.1), `P2`=percent(pc.p2, accuracy=0.1), `Difference`= percent((pc.p1 - pc.p2), accuracy=0.1), 
...
# Black borrowers in CA vs. Black borrowers in rest of US
pc.n1 <- N.ThreeMonExpenses$`Survey respondents`[(N.ThreeMonExpenses$State=="CA") & (N.ThreeMonExpenses$Group=="Black, Non-Hispanic") & (N.ThreeMonExpenses$`Student loan borrower`=="Yes")]
pc.n2 <- N.ThreeMonExpenses$`Survey respondents`[(N.ThreeMonExpenses$State=="Rest of U.S.") & (N.ThreeMonExpenses$Group=="Black, Non-Hispanic") & (N.ThreeMonExpenses$`Student loan borrower`=="Yes")]
pc.p1 <- tblThreeMonExpenses$`Share`[(tblThreeMonExpenses$State=="CA") & (tblThreeMonExpenses$Race=="Black, Non-Hispanic") & (tblThreeMonExpenses$AnyStudentLoans=="Yes") & (tblThreeMonExpenses$variable=="I cannot replace the income needed for three months of expenses")]
pc.p2 <- tblThreeMonExpenses$`Share`[(tblThreeMonExpenses$State=="Rest of U.S.") & (tblThreeMonExpenses$Race=="Black, Non-Hispanic") & (tblThreeMonExpenses$AnyStudentLoans=="Yes") & (tblThreeMonExpenses$variable=="I cannot replace the income needed for three months of expenses")]
power.SHED <- power.SHED %>% add_row(
  `Measure`="Share who cannot replace 3 months of income using savings", 
  `Figure`="Figure 29", 
  `Group 1`="Black borrowers in CA",
...
```{r powerChartEnd, results='asis'}
power.SHED <- power.SHED %>% filter(is.na(`Measure`)==FALSE)
power.SHED$Power <- round(power.SHED$Power, 3)
power.SHED$N1 <- comma(power.SHED$N1)
power.SHED$N2 <- comma(power.SHED$N2)

kable(power.SHED, caption="Checking statistical power values of SHED analyses") %>% kable_paper("hover", full_width = F) %>% scroll_box(height = "400px")
```

#### Data Source and Notes

**Data source:** Survey of Household Economics and Decision-making, accessed November 2022, available through the U.S. Federal Reserve [here](https://www.federalreserve.gov/consumerscommunities/shed_data.htm). See the data notes under the specified figures for more details about individual analyses summarized here. 
...
ca.loans.ALL <- forTable4 %>% filter(State=="CA")
ca.loans.FPC <- ca.loans.ALL %>% filter(Control=="For-profit") 
ca.loans.NPC <- ca.loans.ALL %>% filter(Control=="Non-profit") 
ca.loans.PBC <- ca.loans.ALL %>% filter(Control=="Public") 

F1.weights <- aggregate(data=ca.loans.ALL, cbind(
  `SUBSIDIZED: Recipients`, 
  `UNSUBSIDIZED - UNDERGRADUATE: Recipients`, 
  `UNSUBSIDIZED - GRADUATE: Recipients`, 
  `PARENT PLUS: Recipients`,
  `GRAD PLUS: Recipients`) ~ Control, FUN=sum)
names(F1.weights) <- c("Control", 
                       "Total Subsidized Recipients", 
                       "Total Unsubsidized Undergraduate Recipients", 
                       "Total Unsubsidized Graduate Recipients", 
                       "Total Parent PLUS recipients", 
                       "Total Grad PLUS recipients")
F1.weights.all <- aggregate(data=ca.loans.ALL, cbind(
  `SUBSIDIZED: Recipients`, 
  `UNSUBSIDIZED - UNDERGRADUATE: Recipients`, 
  `UNSUBSIDIZED - GRADUATE: Recipients`, 
  `PARENT PLUS: Recipients`,
  `GRAD PLUS: Recipients`) ~ State, FUN=sum) 
names(F1.weights.all) <- c("State", 
                           "Total Subsidized Recipients", 
                           "Total Unsubsidized Undergraduate Recipients", 
                           "Total Unsubsidized Graduate Recipients", 
                           "Total Parent PLUS recipients", 
...
ca.loans.ALL <- left_join(x=ca.loans.ALL, y=F1.weights.all, by="State")
ca.loans.FPC <- left_join(x=ca.loans.FPC, y=F1.weights, by="Control")
ca.loans.NPC <- left_join(x=ca.loans.NPC, y=F1.weights, by="Control")
ca.loans.PBC <- left_join(x=ca.loans.PBC, y=F1.weights, by="Control")
ca.loans.ALL$Control <- rep("All controls", nrow(ca.loans.ALL))

ca.loans.ALL <- ca.loans.ALL %>% mutate(`Share of Subsidized Recipients` = round(`SUBSIDIZED: Recipients` / `Total Subsidized Recipients`, 3))
ca.loans.ALL <- ca.loans.ALL %>% mutate(`Share of Unsubsidized Undergraduate Recipients` = round(`UNSUBSIDIZED - UNDERGRADUATE: Recipients` / `Total Unsubsidized Undergraduate Recipients`, 3))
ca.loans.ALL <- ca.loans.ALL %>% mutate(`Share of Unsubsidized Graduate Recipients` = round(`UNSUBSIDIZED - GRADUATE: Recipients` / `Total Unsubsidized Graduate Recipients`, 3))
ca.loans.ALL <- ca.loans.ALL %>% mutate(`Share of Parent PLUS Recipients` = round(`PARENT PLUS: Recipients` / `Total Parent PLUS recipients`, 3))
ca.loans.ALL <- ca.loans.ALL %>% mutate(`Share of Grad PLUS Recipients` = round(`GRAD PLUS: Recipients` / `Total Grad PLUS recipients`, 3))

ca.loans.FPC <- ca.loans.FPC %>% mutate(`Share of Subsidized Recipients` = round(`SUBSIDIZED: Recipients` / `Total Subsidized Recipients`, 3)) 
ca.loans.FPC <- ca.loans.FPC %>% mutate(`Share of Unsubsidized Undergraduate Recipients` = round(`UNSUBSIDIZED - UNDERGRADUATE: Recipients` / `Total Unsubsidized Undergraduate Recipients`, 3))
ca.loans.FPC <- ca.loans.FPC %>% mutate(`Share of Unsubsidized Graduate Recipients` = round(`UNSUBSIDIZED - GRADUATE: Recipients` / `Total Unsubsidized Graduate Recipients`, 3))
ca.loans.FPC <- ca.loans.FPC %>% mutate(`Share of Parent PLUS Recipients` = round(`PARENT PLUS: Recipients` / `Total Parent PLUS recipients`, 3))
ca.loans.FPC <- ca.loans.FPC %>% mutate(`Share of Grad PLUS Recipients` = round(`GRAD PLUS: Recipients` / `Total Grad PLUS recipients`, 3))

ca.loans.NPC <- ca.loans.NPC %>% mutate(`Share of Subsidized Recipients` = round(`SUBSIDIZED: Recipients` / `Total Subsidized Recipients`, 3)) 
ca.loans.NPC <- ca.loans.NPC %>% mutate(`Share of Unsubsidized Undergraduate Recipients` = round(`UNSUBSIDIZED - UNDERGRADUATE: Recipients` / `Total Unsubsidized Undergraduate Recipients`, 3))
ca.loans.NPC <- ca.loans.NPC %>% mutate(`Share of Unsubsidized Graduate Recipients` = round(`UNSUBSIDIZED - GRADUATE: Recipients` / `Total Unsubsidized Graduate Recipients`, 3))
ca.loans.NPC <- ca.loans.NPC %>% mutate(`Share of Parent PLUS Recipients` = round(`PARENT PLUS: Recipients` / `Total Parent PLUS recipients`, 3))
ca.loans.NPC <- ca.loans.NPC %>% mutate(`Share of Grad PLUS Recipients` = round(`GRAD PLUS: Recipients` / `Total Grad PLUS recipients`, 3))

ca.loans.PBC <- ca.loans.PBC %>% mutate(`Share of Subsidized Recipients` = round(`SUBSIDIZED: Recipients` / `Total Subsidized Recipients`, 3)) 
ca.loans.PBC <- ca.loans.PBC %>% mutate(`Share of Unsubsidized Undergraduate Recipients` = round(`UNSUBSIDIZED - UNDERGRADUATE: Recipients` / `Total Unsubsidized Undergraduate Recipients`, 3))
ca.loans.PBC <- ca.loans.PBC %>% mutate(`Share of Unsubsidized Graduate Recipients` = round(`UNSUBSIDIZED - GRADUATE: Recipients` / `Total Unsubsidized Graduate Recipients`, 3))
ca.loans.PBC <- ca.loans.PBC %>% mutate(`Share of Parent PLUS Recipients` = round(`PARENT PLUS: Recipients` / `Total Parent PLUS recipients`, 3))
ca.loans.PBC <- ca.loans.PBC %>% mutate(`Share of Grad PLUS Recipients` = round(`GRAD PLUS: Recipients` / `Total Grad PLUS recipients`, 3))

ca.loans.ALL <- ca.loans.ALL %>% select(OPEID, School, Control, `Share of Subsidized Recipients`, `Share of Unsubsidized Undergraduate Recipients`, `Share of Unsubsidized Graduate Recipients`, `Share of Parent PLUS Recipients`, `Share of Grad PLUS Recipients`)
ca.loans.FPC <- ca.loans.FPC %>% select(OPEID, School, Control, `Share of Subsidized Recipients`, `Share of Unsubsidized Undergraduate Recipients`, `Share of Unsubsidized Graduate Recipients`, `Share of Parent PLUS Recipients`, `Share of Grad PLUS Recipients`)
ca.loans.NPC <- ca.loans.NPC %>% select(OPEID, School, Control, `Share of Subsidized Recipients`, `Share of Unsubsidized Undergraduate Recipients`, `Share of Unsubsidized Graduate Recipients`, `Share of Parent PLUS Recipients`, `Share of Grad PLUS Recipients`)
ca.loans.PBC <- ca.loans.PBC %>% select(OPEID, School, Control, `Share of Subsidized Recipients`, `Share of Unsubsidized Undergraduate Recipients`, `Share of Unsubsidized Graduate Recipients`, `Share of Parent PLUS Recipients`, `Share of Grad PLUS Recipients`)

ca.loans <- rbind(ca.loans.ALL, ca.loans.FPC, ca.loans.NPC, ca.loans.PBC)

forTable4 <- forTable4 %>% mutate(`Institution's average Subsidized loan` = `SUBSIDIZED: $ of Disbursements` / `SUBSIDIZED: Recipients`)
forTable4 <- forTable4 %>% mutate(`Institution's average Unsubsidized Undergraduate loan` = `UNSUBSIDIZED - UNDERGRADUATE: $ of Disbursements` / `UNSUBSIDIZED - UNDERGRADUATE: Recipients`)
forTable4 <- forTable4 %>% mutate(`Institution's average Unsubsidized Graduate loan` = `UNSUBSIDIZED - GRADUATE: $ of Disbursements` / `UNSUBSIDIZED - GRADUATE: Recipients`)
forTable4 <- forTable4 %>% mutate(`Institution's average Parent PLUS loan` = `PARENT PLUS: $ of Disbursements` / `PARENT PLUS: Recipients`)
forTable4 <- forTable4 %>% mutate(`Institution's average Grad PLUS loan` = `GRAD PLUS: $ of Disbursements` / `GRAD PLUS: Recipients`)

ca.loans0 <- forTable4 %>% select(OPEID, `Institution's average Subsidized loan`, `Institution's average Unsubsidized Undergraduate loan`, `Institution's average Unsubsidized Graduate loan`, `Institution's average Parent PLUS loan`, `Institution's average Grad PLUS loan`)
ca.loans <- left_join(x=ca.loans, y=ca.loans0, by="OPEID")

# Getting data on the average loan by sector and program 

ca.loans1 <- table4 %>% filter(State=="CA") %>% select(`Control`, `Subsidized`, `Unsub. UG`, `Unsub. Grad.`, `Parent PLUS`, `Grad PLUS`) 
names(ca.loans1) <- c("Control", 
                      "Global average Subsidized loan", 
                      "Global average Unsubsidized Undergraduate loan", 
                      "Global average Unsubsidized Graduate loan", 
                      "Global average Parent PLUS loan", 
                      "Global average Grad PLUS loan")
ca.loans <- left_join(x=ca.loans, y=ca.loans1, by="Control")

ca.loans.subsidized <- ca.loans %>% select(`OPEID`, `School`, `Control`, 
                                           `Share of Subsidized Recipients`, 
                                           `Institution's average Subsidized loan`, 
                                           `Global average Subsidized loan`)
ca.loans.unsubsidizedUG <- ca.loans %>% select(`OPEID`, `School`, `Control`, 
                                               `Share of Unsubsidized Undergraduate Recipients`, 
                                               `Institution's average Unsubsidized Undergraduate loan`, 
                                               `Global average Unsubsidized Undergraduate loan`)
ca.loans.unsubsidizedGD <- ca.loans %>% select(`OPEID`, `School`, `Control`, 
                                               `Share of Unsubsidized Graduate Recipients`, 
                                               `Institution's average Unsubsidized Graduate loan`, 
                                               `Global average Unsubsidized Graduate loan`)
ca.loans.ParentPLUS <- ca.loans %>% select(`OPEID`, `School`, `Control`, 
                                           `Share of Parent PLUS Recipients`, 
                                           `Institution's average Parent PLUS loan`, 
                                           `Global average Parent PLUS loan`) 
ca.loans.GradPLUS <- ca.loans %>% select(`OPEID`, `School`, `Control`, 
                                         `Share of Grad PLUS Recipients`, 
                                         `Institution's average Grad PLUS loan`, 
                                         `Global average Grad PLUS loan`) 

ca.loans.subsidized$`Loan program` <- rep("Subsidized", nrow(ca.loans.subsidized))
ca.loans.unsubsidizedUG$`Loan program` <- rep("Unsubsidized Undergraduate", nrow(ca.loans.unsubsidizedUG))
ca.loans.unsubsidizedGD$`Loan program` <- rep("Unsubsidized Graduate", nrow(ca.loans.unsubsidizedGD))
ca.loans.ParentPLUS$`Loan program` <- rep("Parent PLUS", nrow(ca.loans.ParentPLUS))
ca.loans.GradPLUS$`Loan program` <- rep("Grad PLUS", nrow(ca.loans.GradPLUS))

names(ca.loans.subsidized) <- c("OPEID", "School", "Control", "Share of loan recipients", "Institution's average loan", "Sector-wide average loan", "Loan program")
names(ca.loans.unsubsidizedUG) <- c("OPEID", "School", "Control", "Share of loan recipients", "Institution's average loan", "Sector-wide average loan", "Loan program")
names(ca.loans.unsubsidizedGD) <- c("OPEID", "School", "Control", "Share of loan recipients", "Institution's average loan", "Sector-wide average loan", "Loan program")
names(ca.loans.ParentPLUS) <- c("OPEID", "School", "Control", "Share of loan recipients", "Institution's average loan", "Sector-wide average loan", "Loan program")
names(ca.loans.GradPLUS) <- c("OPEID", "School", "Control", "Share of loan recipients", "Institution's average loan", "Sector-wide average loan", "Loan program")

ca.loans2 <- rbind(ca.loans.subsidized, ca.loans.unsubsidizedUG, ca.loans.unsubsidizedGD, ca.loans.ParentPLUS, ca.loans.GradPLUS)
ca.loans2 <- ca.loans2 %>% mutate(`Ratio of institution's average loan to sector average` = `Institution's average loan` / `Sector-wide average loan`)
```

```{r figure41}
ca.loans2$`Loan program` <- as.factor(ca.loans2$`Loan program`)
ca.loans2$`Loan program` <- factor(ca.loans2$`Loan program`, levels=c(
  "Subsidized",
...
ca.loans2$`Control` <- as.factor(ca.loans2$`Control`)
ca.loans2$`Control` <- factor(ca.loans2$`Control`, levels=c(
  "All controls",
  "Public", 
  "Non-profit", 
  "For-profit"
...
ca.loans2$`For Tooltip` <- paste(
  "College: ", ca.loans2$School, '\n',
  "Program: ", ca.loans2$`Loan program`, '\n',
  "Control: ", ca.loans2$`Control`, '\n',
  "College's share of California loan recipients: ", percent(ca.loans2$`Share of loan recipients`, accuracy=0.1), '\n',
  "College's average loan: ", dollar(ca.loans2$`Institution's average loan`, accuracy=1), '\n',
  "Sector-wide average loan: ", dollar(ca.loans2$`Sector-wide average loan`, accuracy=1), '\n',
  "Ratio of institution's average loan to sector average: ", round(ca.loans2$`Ratio of institution's average loan to sector average`, 3),
  sep=""
)

g41 <- ggplot(data=ca.loans2, mapping=aes(x=`Share of loan recipients`, y=`Ratio of institution's average loan to sector average`, text=`For Tooltip`)) + geom_point(stat="identity", alpha=0.7) + geom_hline(yintercept=1, linetype=4) + facet_grid(`Control` ~ `Loan program`) + theme(legend.position='none', text=element_text(family="Optima")) + labs(x="Institution's share of California loan recipients, 2018-19") + scale_x_continuous(labels=percent_format(accuracy=1))

ggplotly(g41, width=900, height=800, tooltip="text")
```
#### Data Source and Notes
...
```{r check.Scorecard1}
Q42 <- Q28.check %>% filter(State=="California")

Q42.S <- Q42 %>% select(
  UNITID, INSTNM, Control, 
  DBRR1_FED_UG_N, DBRR1_FED_UG_NUM, DBRR1_FED_UG_DEN, 
  DBRR5_FED_UG_N, DBRR5_FED_UG_NUM, DBRR5_FED_UG_DEN, 
  DBRR10_FED_UG_N, DBRR10_FED_UG_NUM, DBRR10_FED_UG_DEN, 
  DBRR20_FED_UG_N, DBRR20_FED_UG_NUM, DBRR20_FED_UG_DEN)

Q42.P <- Q42 %>% select(
  UNITID, INSTNM, Control, 
  DBRR1_PP_UG_N, DBRR1_PP_UG_NUM, DBRR1_PP_UG_DEN,
  DBRR5_PP_UG_N, DBRR5_PP_UG_NUM, DBRR5_PP_UG_DEN,
  DBRR10_PP_UG_N, DBRR10_PP_UG_NUM, DBRR10_PP_UG_DEN, 
  DBRR20_PP_UG_N, DBRR20_PP_UG_NUM, DBRR20_PP_UG_DEN)

Q42.G <- Q42 %>% select(
  UNITID, INSTNM, Control, 
  DBRR1_FED_GR_N, DBRR1_FED_GR_NUM, DBRR1_FED_GR_DEN,
  DBRR5_FED_GR_N, DBRR5_FED_GR_NUM, DBRR5_FED_GR_DEN, 
  DBRR10_FED_GR_N, DBRR10_FED_GR_NUM, DBRR10_FED_GR_DEN, 
  DBRR20_FED_GR_N, DBRR20_FED_GR_NUM, DBRR20_FED_GR_DEN)

Q42.S <- reshape2::melt(data=Q42.S, id.vars=c("UNITID", "INSTNM", "Control"))
Q42.P <- reshape2::melt(data=Q42.P, id.vars=c("UNITID", "INSTNM", "Control"))
Q42.G <- reshape2::melt(data=Q42.G, id.vars=c("UNITID", "INSTNM", "Control"))
Q42.S$Program <- rep("Stafford undergraduate loans", nrow(Q42.S))
Q42.P$Program <- rep("Parent PLUS loans", nrow(Q42.P))
Q42.G$Program <- rep("Graduate loans", nrow(Q42.G))

Q42.S$Year <- rep(NA, nrow(Q42.S))
Q42.S$Year[grepl("DBRR1_", Q42.S$variable)] <- 1
Q42.S$Year[grepl("DBRR5_", Q42.S$variable)] <- 5
Q42.S$Year[grepl("DBRR10_", Q42.S$variable)] <- 10
Q42.S$Year[grepl("DBRR20_", Q42.S$variable)] <- 20
Q42.S$Measure <- rep(NA, nrow(Q42.S))
Q42.S$Measure[grepl("_N", Q42.S$variable)] <- "Institutional borrower count"
Q42.S$Measure[grepl("_NUM", Q42.S$variable)] <- "Institutional balance at repayment year X" 
Q42.S$Measure[grepl("_DEN", Q42.S$variable)] <- "Institutional original balance"

Q42.P$Year <- rep(NA, nrow(Q42.P))
Q42.P$Year[grepl("DBRR1_", Q42.P$variable)] <- 1
Q42.P$Year[grepl("DBRR5_", Q42.P$variable)] <- 5
Q42.P$Year[grepl("DBRR10_", Q42.P$variable)] <- 10
Q42.P$Year[grepl("DBRR20_", Q42.P$variable)] <- 20
Q42.P$Measure <- rep(NA, nrow(Q42.P))
Q42.P$Measure[grepl("_N", Q42.P$variable)] <- "Institutional borrower count"
Q42.P$Measure[grepl("_NUM", Q42.P$variable)] <- "Institutional balance at repayment year X" 
Q42.P$Measure[grepl("_DEN", Q42.P$variable)] <- "Institutional original balance"

Q42.G$Year <- rep(NA, nrow(Q42.G))
Q42.G$Year[grepl("DBRR1_", Q42.G$variable)] <- 1
Q42.G$Year[grepl("DBRR5_", Q42.G$variable)] <- 5
Q42.G$Year[grepl("DBRR10_", Q42.G$variable)] <- 10
Q42.G$Year[grepl("DBRR20_", Q42.G$variable)] <- 20
Q42.G$Measure <- rep(NA, nrow(Q42.G))
Q42.G$Measure[grepl("_N", Q42.G$variable)] <- "Institutional borrower count"
Q42.G$Measure[grepl("_NUM", Q42.G$variable)] <- "Institutional balance at repayment year X" 
Q42.G$Measure[grepl("_DEN", Q42.G$variable)] <- "Institutional original balance"

Q42.S <- reshape2::dcast(data=Q42.S, UNITID + INSTNM + Control + Program + Year ~ Measure, value.var="value")
Q42.P <- reshape2::dcast(data=Q42.P, UNITID + INSTNM + Control + Program + Year ~ Measure, value.var="value")
Q42.G <- reshape2::dcast(data=Q42.G, UNITID + INSTNM + Control + Program + Year ~ Measure, value.var="value")

Q42.S <- Q42.S %>% filter(`Institutional borrower count` > 0)
Q42.G <- Q42.G %>% filter(`Institutional borrower count` > 0)
Q42.P <- Q42.P %>% filter(`Institutional borrower count` > 0)

Q42.S.All <- Q42.S
Q42.S.All$Control <- rep("All controls", nrow(Q42.S.All))
Q42.P.All <- Q42.P
Q42.P.All$Control <- rep("All controls", nrow(Q42.P.All))
Q42.G.All <- Q42.G
Q42.G.All$Control <- rep("All controls", nrow(Q42.G.All))

Q42.S <- rbind(Q42.S, Q42.S.All)
Q42.P <- rbind(Q42.P, Q42.P.All)
Q42.G <- rbind(Q42.G, Q42.G.All)

all.borrowers.S <- aggregate(data=Q42.S, cbind(`Institutional borrower count`, `Institutional balance at repayment year X`, `Institutional original balance`) ~ `Control` + `Year`, FUN=sum)
all.borrowers.P <- aggregate(data=Q42.P, cbind(`Institutional borrower count`, `Institutional balance at repayment year X`, `Institutional original balance`) ~ `Control` + `Year`, FUN=sum)
all.borrowers.G <- aggregate(data=Q42.G, cbind(`Institutional borrower count`, `Institutional balance at repayment year X`, `Institutional original balance`) ~ `Control` + `Year`, FUN=sum)
names(all.borrowers.S) <- c("Control", "Year", "Global borrower count", "Global balance at repayment year X", "Global original balance")
names(all.borrowers.P) <- c("Control", "Year", "Global borrower count", "Global balance at repayment year X", "Global original balance")
names(all.borrowers.G) <- c("Control", "Year", "Global borrower count", "Global balance at repayment year X", "Global original balance")

Q42.S <- left_join(x=Q42.S, y=all.borrowers.S, by=c("Control", "Year"))
Q42.P <- left_join(x=Q42.P, y=all.borrowers.P, by=c("Control", "Year"))
Q42.G <- left_join(x=Q42.G, y=all.borrowers.G, by=c("Control", "Year"))

Q42.S <- Q42.S %>% mutate(`Institution's share of all borrowers` = `Institutional borrower count` / `Global borrower count`)
Q42.P <- Q42.P %>% mutate(`Institution's share of all borrowers` = `Institutional borrower count` / `Global borrower count`)
Q42.G <- Q42.G %>% mutate(`Institution's share of all borrowers` = `Institutional borrower count` / `Global borrower count`)

Q42.S <- Q42.S %>% mutate(`Institutional DBRR ratio` = `Institutional balance at repayment year X` / `Institutional original balance`)
Q42.P <- Q42.P %>% mutate(`Institutional DBRR ratio` = `Institutional balance at repayment year X` / `Institutional original balance`)
Q42.G <- Q42.G %>% mutate(`Institutional DBRR ratio` = `Institutional balance at repayment year X` / `Institutional original balance`)

Q42.S <- Q42.S %>% mutate(`Global DBRR ratio` = `Global balance at repayment year X` / `Global original balance`)
Q42.P <- Q42.P %>% mutate(`Global DBRR ratio` = `Global balance at repayment year X` / `Global original balance`)
Q42.G <- Q42.G %>% mutate(`Global DBRR ratio` = `Global balance at repayment year X` / `Global original balance`)

Q42.S <- Q42.S %>% mutate(`Institution's average balance` = `Institutional balance at repayment year X` / `Institutional borrower count`)
Q42.P <- Q42.P %>% mutate(`Institution's average balance` = `Institutional balance at repayment year X` / `Institutional borrower count`)
Q42.G <- Q42.G %>% mutate(`Institution's average balance` = `Institutional balance at repayment year X` / `Institutional borrower count`)

Q42.S <- Q42.S %>% mutate(`Global average balance` = `Global balance at repayment year X` / `Global borrower count`)
Q42.P <- Q42.P %>% mutate(`Global average balance` = `Global balance at repayment year X` / `Global borrower count`)
Q42.G <- Q42.G %>% mutate(`Global average balance` = `Global balance at repayment year X` / `Global borrower count`)

Q42.S <- Q42.S %>% mutate(`Difference in ratios` = `Institutional DBRR ratio` - `Global DBRR ratio`)
Q42.P <- Q42.P %>% mutate(`Difference in ratios` = `Institutional DBRR ratio` - `Global DBRR ratio`)
Q42.G <- Q42.G %>% mutate(`Difference in ratios` = `Institutional DBRR ratio` - `Global DBRR ratio`)

Q42.S <- Q42.S %>% mutate(`Ratio of average balance` = `Institution's average balance` / `Global average balance`)
Q42.P <- Q42.P %>% mutate(`Ratio of average balance` = `Institution's average balance` / `Global average balance`)
Q42.G <- Q42.G %>% mutate(`Ratio of average balance` = `Institution's average balance` / `Global average balance`)
...
```
### {.tabset}
#### Figure 42: Stafford undergraduate loans
```{r figure42S}
Q42.S$`For Tooltip` <- paste(
  "College: ", Q42.S$INSTNM, '\n',
  "Sector: ", Q42.S$Control, '\n',
  "Program: ", Q42.S$`Program`, '\n',
  "Repayment year: ", Q42.S$`Year`, '\n',
  "Number of borrowers in cohort: ", Q42.S$`Institutional borrower count`, '\n',
  "College's share of borrowers in cohort: ", percent(Q42.S$`Institution's share of all borrowers`, accuracy=0.1), '\n',
  "College's repayment ratio: ", round(Q42.S$`Institutional DBRR ratio`, 2), '\n',
  "Sector-wide repayment ratio: ", round(Q42.S$`Global DBRR ratio`, 2), '\n',
  "Difference in ratios: ", round(Q42.S$`Difference in ratios`, 2), 
  sep=""
)

Q42.S$Year <- paste("Year ", Q42.S$Year, sep="")
Q42.S$Year <- as.factor(Q42.S$Year)
Q42.S$Year <- factor(Q42.S$Year, levels=c("Year 1", "Year 5", "Year 10", "Year 20"))

g42S <- ggplot(data=Q42.S, mapping=aes(x=`Institution's share of all borrowers`, y=`Difference in ratios`, text=`For Tooltip`)) + geom_point(stat="identity", alpha=0.7) + geom_hline(yintercept=0, linetype=4) + facet_grid(`Control` ~ `Year`) + theme(legend.position='none', text=element_text(family="Optima")) + labs(x="Institution's share of California borrower cohort") + scale_x_continuous(labels=percent_format(accuracy=1))

ggplotly(g42S, width=900, height=800, tooltip="text")
```
#### Figure 42: Parent PLUS loans
```{r figure42P}
Q42.P$`For Tooltip` <- paste(
  "College: ", Q42.P$INSTNM, '\n',
  "Sector: ", Q42.P$Control, '\n',
  "Program: ", Q42.P$`Program`, '\n',
  "Repayment year: ", Q42.P$`Year`, '\n',
  "Number of borrowers in cohort: ", Q42.P$`Institutional borrower count`, '\n',
  "College's share of borrowers in cohort: ", percent(Q42.P$`Institution's share of all borrowers`, accuracy=0.1), '\n',
  "College's repayment ratio: ", round(Q42.P$`Institutional DBRR ratio`, 2), '\n',
  "Sector-wide repayment ratio: ", round(Q42.P$`Global DBRR ratio`, 2), '\n',
  "Difference in ratios: ", round(Q42.P$`Difference in ratios`, 2), 
  sep=""
)

Q42.P$Year <- paste("Year ", Q42.P$Year, sep="")
Q42.P$Year <- as.factor(Q42.P$Year)
Q42.P$Year <- factor(Q42.P$Year, levels=c("Year 1", "Year 5", "Year 10", "Year 20"))

g42P <- ggplot(data=Q42.P, mapping=aes(x=`Institution's share of all borrowers`, y=`Difference in ratios`, text=`For Tooltip`)) + geom_point(stat="identity", alpha=0.7) + geom_hline(yintercept=0, linetype=4) + facet_grid(`Control` ~ `Year`) + theme(legend.position='none', text=element_text(family="Optima")) + labs(x="Institution's share of California borrower cohort") + scale_x_continuous(labels=percent_format(accuracy=1))

ggplotly(g42P, width=900, height=800, tooltip="text")
```
#### Figure 42: Graduate loans
```{r figure42G}
Q42.G$`For Tooltip` <- paste(
  "College: ", Q42.G$INSTNM, '\n',
  "Sector: ", Q42.G$Control, '\n',
  "Program: ", Q42.G$`Program`, '\n',
  "Repayment year: ", Q42.G$`Year`, '\n',
  "Number of borrowers in cohort: ", Q42.G$`Institutional borrower count`, '\n',
  "College's share of borrowers in cohort: ", percent(Q42.G$`Institution's share of all borrowers`, accuracy=0.1), '\n',
  "College's repayment ratio: ", round(Q42.G$`Institutional DBRR ratio`, 2), '\n',
  "Sector-wide repayment ratio: ", round(Q42.G$`Global DBRR ratio`, 2), '\n',
  "Difference in ratios: ", round(Q42.G$`Difference in ratios`, 2), 
  sep=""
)

Q42.G$Year <- paste("Year ", Q42.G$Year, sep="")
Q42.G$Year <- as.factor(Q42.G$Year)
Q42.G$Year <- factor(Q42.G$Year, levels=c("Year 1", "Year 5", "Year 10", "Year 20"))

g42G <- ggplot(data=Q42.G, mapping=aes(x=`Institution's share of all borrowers`, y=`Difference in ratios`, text=`For Tooltip`)) + geom_point(stat="identity", alpha=0.7) + geom_hline(yintercept=0, linetype=4) + facet_grid(`Control` ~ `Year`) + theme(legend.position='none', text=element_text(family="Optima")) + labs(x="Institution's share of California borrower cohort") + scale_x_continuous(labels=percent_format(accuracy=1))

ggplotly(g42G, width=900, height=800, tooltip="text")
```
#### Data Source and Notes
...
### {.tabset}
#### Figure 43: Stafford undergraduate loans
```{r figure43S}
Q43.S$`For Tooltip` <- paste(
  "College: ", Q43.S$INSTNM, '\n',
  "Sector: ", Q43.S$Control, '\n',
  "Program: ", Q43.S$`Program`, '\n',
  "Repayment year: ", Q43.S$`Year`, '\n',
  "Number of borrowers in cohort: ", Q43.S$`Institutional borrower count`, '\n',
  "College's share of borrowers in cohort: ", percent(Q43.S$`Institution's share of all borrowers`, accuracy=0.1), '\n',
  "College's average loan balance: ", dollar(Q43.S$`Institution's average balance`, accuracy=1), '\n',
  "Sector-wide average loan balance: ", dollar(Q43.S$`Global average balance`, accuracy=1), '\n',
  "Ratio of college's average to sector average: ", round(Q43.S$`Ratio of average balance`, 2), 
  sep=""
)

Q43.S$Year <- paste("Year ", Q43.S$Year, sep="")
Q43.S$Year <- as.factor(Q43.S$Year)
Q43.S$Year <- factor(Q43.S$Year, levels=c("Year 1", "Year 5", "Year 10", "Year 20"))

g43S <- ggplot(data=Q43.S, mapping=aes(x=`Institution's share of all borrowers`, y=`Ratio of average balance`, text=`For Tooltip`)) + geom_point(stat="identity", alpha=0.7) + geom_hline(yintercept=1, linetype=4) + facet_grid(`Control` ~ `Year`) + theme(legend.position='none', text=element_text(family="Optima")) + labs(x="Institution's share of California borrower cohort") + scale_x_continuous(labels=percent_format(accuracy=1))

ggplotly(g43S, width=900, height=800, tooltip="text")
```
#### Figure 43: Parent PLUS loans
```{r figure43P}
Q43.P$`For Tooltip` <- paste(
  "College: ", Q43.P$INSTNM, '\n',
  "Sector: ", Q43.P$Control, '\n',
  "Program: ", Q43.P$`Program`, '\n',
  "Repayment year: ", Q43.P$`Year`, '\n',
  "Number of borrowers in cohort: ", Q43.P$`Institutional borrower count`, '\n',
  "College's share of borrowers in cohort: ", percent(Q43.P$`Institution's share of all borrowers`, accuracy=0.1), '\n',
  "College's average loan balance: ", dollar(Q43.P$`Institution's average balance`, accuracy=1), '\n',
  "Sector-wide average loan balance: ", dollar(Q43.P$`Global average balance`, accuracy=1), '\n',
  "Ratio of college's average to sector average: ", round(Q43.P$`Ratio of average balance`, 2), 
  sep=""
)

Q43.P$Year <- paste("Year ", Q43.P$Year, sep="")
Q43.P$Year <- as.factor(Q43.P$Year)
Q43.P$Year <- factor(Q43.P$Year, levels=c("Year 1", "Year 5", "Year 10", "Year 20"))

g43P <- ggplot(data=Q43.P, mapping=aes(x=`Institution's share of all borrowers`, y=`Ratio of average balance`, text=`For Tooltip`)) + geom_point(stat="identity", alpha=0.7) + geom_hline(yintercept=1, linetype=4) + facet_grid(`Control` ~ `Year`) + theme(legend.position='none', text=element_text(family="Optima")) + labs(x="Institution's share of California borrower cohort") + scale_x_continuous(labels=percent_format(accuracy=1))

ggplotly(g43P, width=900, height=800, tooltip="text")
```
#### Figure 43: Graduate loans
```{r figure43G}
Q43.G$`For Tooltip` <- paste(
  "College: ", Q43.G$INSTNM, '\n',
  "Sector: ", Q43.G$Control, '\n',
  "Program: ", Q43.G$`Program`, '\n',
  "Repayment year: ", Q43.G$`Year`, '\n',
  "Number of borrowers in cohort: ", Q43.G$`Institutional borrower count`, '\n',
  "College's share of borrowers in cohort: ", percent(Q43.G$`Institution's share of all borrowers`, accuracy=0.1), '\n',
  "College's average loan balance: ", dollar(Q43.G$`Institution's average balance`, accuracy=1), '\n',
  "Sector-wide average loan balance: ", dollar(Q43.G$`Global average balance`, accuracy=1), '\n',
  "Ratio of college's average to sector average: ", round(Q43.G$`Ratio of average balance`, 2), 
  sep=""
)

Q43.G$Year <- paste("Year ", Q43.G$Year, sep="")
Q43.G$Year <- as.factor(Q43.G$Year)
Q43.G$Year <- factor(Q43.G$Year, levels=c("Year 1", "Year 5", "Year 10", "Year 20"))

g43G <- ggplot(data=Q43.G, mapping=aes(x=`Institution's share of all borrowers`, y=`Ratio of average balance`, text=`For Tooltip`)) + geom_point(stat="identity", alpha=0.7) + geom_hline(yintercept=1, linetype=4) + facet_grid(`Control` ~ `Year`) + theme(legend.position='none', text=element_text(family="Optima")) + labs(x="Institution's share of California borrower cohort") + scale_x_continuous(labels=percent_format(accuracy=1))

ggplotly(g43G, width=900, height=800, tooltip="text")
```
#### Data Source and Notes
...
#### Table 14
```{r check.NPSAS1}
# Figure 2: Share borrowing  
# Overall CA  # Line 124, D-E
# Overall US  # Line 60, D-E
# White in CA # Line 126, D-E
# Black in CA # Line 127, D-E
# File: "PowerStats njviui.csv"

NC.1.1 <- read.csv("PowerStats njviui.csv", header=FALSE, skip=(124 - 1), nrow=1) %>% select(V1, V4, V5)
NC.1.1$Group <- c("Overall")
NC.1.1$State <- c("CA")

NC.1.2 <- read.csv("PowerStats njviui.csv", header=FALSE, skip=(60 - 1), nrow=1) %>% select(V1, V4, V5)
NC.1.2$Group <- c("Overall")
NC.1.2$State <- c("US")

NC.1.3 <- read.csv("PowerStats njviui.csv", header=FALSE, skip=(126 - 1), nrow=1) %>% select(V1, V4, V5)
NC.1.3$Group <- c("White")
NC.1.3$State <- c("CA")

NC.1.4 <- read.csv("PowerStats njviui.csv", header=FALSE, skip=(127 - 1), nrow=1) %>% select(V1, V4, V5)
NC.1.4$Group <- c("Black")
NC.1.4$State <- c("CA")

NC.1 <- rbind(NC.1.1, NC.1.2, NC.1.3, NC.1.4)
NC.1$`Measure` <- rep("Share borrowing undergraduate loans", nrow(NC.1))
NC.1$`Figure` <- rep("Figure 2", nrow(NC.1))
NC.1$`Type` <- rep("Percentage", nrow(NC.1))
```

```{r check.NPSAS2}
# Figure 2: Average loan
# Overall CA # Line 119, B-C
# Overall US # Line 58, B-C
# File: "Powerstats opspco.csv"

NC.2.1 <- read.csv("Powerstats opspco.csv", header=FALSE, skip=(119 - 1), nrow=1) %>% select(V1, V2, V3)
NC.2.1$Group <- c("Overall")
NC.2.1$State <- c("CA")

NC.2.2 <- read.csv("Powerstats opspco.csv", header=FALSE, skip=(58 - 1), nrow=1) %>% select(V1, V2, V3)
NC.2.2$Group <- c("Overall")
NC.2.2$State <- c("US")

NC.2 <- rbind(NC.2.1, NC.2.2)
NC.2$`Measure` <- rep("Average undergraduate loan", nrow(NC.2))
NC.2$`Figure` <- rep("Figure 2", nrow(NC.2))
NC.2$`Type` <- rep("Dollar", nrow(NC.2))
```

```{r check.NPSAS3}
# Figure 3: Share borrowing 
# Overall CA   # Line 124, D-E
# Overall US   # Line 60, D-E
# Black in CA  # Line 127, D-E 
# Black in US  # Line 63, D-E 
# Latino in CA # Line 128, D-E
# Latino in US # Line 64, D-E
# White in CA  # Line 126, D-E
# White in US  # Line 62, D-E
# File: "Powerstats lhkurg.csv"

NC.3.1 <- read.csv("Powerstats lhkurg.csv", header=FALSE, skip=(124 - 1), nrow=1) %>% select(V1, V4, V5)
NC.3.1$Group <- c("Overall")
NC.3.1$State <- c("CA")

NC.3.2 <- read.csv("Powerstats lhkurg.csv", header=FALSE, skip=(60 - 1), nrow=1) %>% select(V1, V4, V5)
NC.3.2$Group <- c("Overall")
NC.3.2$State <- c("US")

NC.3.3 <- read.csv("Powerstats lhkurg.csv", header=FALSE, skip=(127 - 1), nrow=1) %>% select(V1, V4, V5)
NC.3.3$Group <- c("Black")
NC.3.3$State <- c("CA")

NC.3.4 <- read.csv("Powerstats lhkurg.csv", header=FALSE, skip=(63 - 1), nrow=1) %>% select(V1, V4, V5)
NC.3.4$Group <- c("Black")
NC.3.4$State <- c("US")

NC.3.5 <- read.csv("Powerstats lhkurg.csv", header=FALSE, skip=(128 - 1), nrow=1) %>% select(V1, V4, V5)
NC.3.5$Group <- c("Latino/a")
NC.3.5$State <- c("CA")

NC.3.6 <- read.csv("Powerstats lhkurg.csv", header=FALSE, skip=(64 - 1), nrow=1) %>% select(V1, V4, V5)
NC.3.6$Group <- c("Latino/a")
NC.3.6$State <- c("US")

NC.3.7 <- read.csv("Powerstats lhkurg.csv", header=FALSE, skip=(126 - 1), nrow=1) %>% select(V1, V4, V5)
NC.3.7$Group <- c("White")
NC.3.7$State <- c("CA")

NC.3.8 <- read.csv("Powerstats lhkurg.csv", header=FALSE, skip=(62 - 1), nrow=1) %>% select(V1, V4, V5)
NC.3.8$Group <- c("White")
NC.3.8$State <- c("US")

NC.3 <- rbind(NC.3.1, NC.3.2, NC.3.3, NC.3.4, NC.3.5, NC.3.6, NC.3.7, NC.3.8)
NC.3$`Measure` <- rep("Share borrowing graduate loans", nrow(NC.3))
NC.3$`Figure` <- rep("Figure 3", nrow(NC.3))
NC.3$`Type` <- rep("Percentage", nrow(NC.3))
```

```{r check.NPSAS4}
# Figure 3: Share borrowing (race/gender)
# Black women in CA # Line 194
# Overall CA        # Line 187
# File: "Powerstats ukuclj.csv"

NC.4.1 <- read.csv("Powerstats ukuclj.csv", header=FALSE, skip=(194 - 1), nrow=1) %>% select(V1, V4, V5)
NC.4.1$Group <- c("Black women")
NC.4.1$State <- c("CA")

NC.4.2 <- read.csv("Powerstats ukuclj.csv", header=FALSE, skip=(187 - 1), nrow=1) %>% select(V1, V4, V5)
NC.4.2$Group <- c("Overall")
NC.4.2$State <- c("CA")

NC.4 <- rbind(NC.4.1, NC.4.2)
NC.4$`Measure` <- rep("Share borrowing graduate loans", nrow(NC.4))
NC.4$`Figure` <- rep("Figure 3", nrow(NC.4))
NC.4$`Type` <- rep("Percentage", nrow(NC.4))
```

```{r check.NPSAS5}
# Figure 3: Average loan 
# Overall CA   # Line 119, B-C 
# Black in CA  # Line 122, B-C
# Black in US  # Line 61, B-C
# Latino in CA # Line 123, B-C
# Latino in US # Line 62, B-C
# File: "Powerstats avflfm.csv"

NC.5.1 <- read.csv("Powerstats avflfm.csv", header=FALSE, skip=(119 - 1), nrow=1) %>% select(V1, V2, V3)
NC.5.1$Group <- c("Overall")
NC.5.1$State <- c("CA")

NC.5.2 <- read.csv("Powerstats avflfm.csv", header=FALSE, skip=(122 - 1), nrow=1) %>% select(V1, V2, V3)
NC.5.2$Group <- c("Black")
NC.5.2$State <- c("CA")

NC.5.3 <- read.csv("Powerstats avflfm.csv", header=FALSE, skip=(61 - 1), nrow=1) %>% select(V1, V2, V3)
NC.5.3$Group <- c("Black")
NC.5.3$State <- c("US")

NC.5.4 <- read.csv("Powerstats avflfm.csv", header=FALSE, skip=(123 - 1), nrow=1) %>% select(V1, V2, V3)
NC.5.4$Group <- c("Latino/a")
NC.5.4$State <- c("CA")

NC.5.5 <- read.csv("Powerstats avflfm.csv", header=FALSE, skip=(62 - 1), nrow=1) %>% select(V1, V2, V3)
NC.5.5$Group <- c("Latino/a")
NC.5.5$State <- c("US")

NC.5 <- rbind(NC.5.1, NC.5.2, NC.5.3, NC.5.4, NC.5.5)
NC.5$`Measure` <- rep("Average graduate loan", nrow(NC.5))
NC.5$`Figure` <- rep("Figure 3", nrow(NC.5))
NC.5$`Type` <- rep("Dollar", nrow(NC.5))
```

```{r check.NPSAS6}
# Figure 5: Share borrowing 
# Black in CA            # Line 127, D-E
# Latino in CA           # Line 128, D-E
# Pacific Islander in CA # Line 131, D-E
# Asian in CA            # Line 129, D-E
# White in CA            # Line 126, D-E 
# Overall CA             # Line 124, D-E
# File: "PowerStats admfpj.csv"

NC.6.1 <- read.csv("PowerStats admfpj.csv", header=FALSE, skip=(127 - 1), nrow=1) %>% select(V1, V4, V5)
NC.6.1$Group <- c("Black")
NC.6.1$State <- c("CA")

NC.6.2 <- read.csv("PowerStats admfpj.csv", header=FALSE, skip=(128 - 1), nrow=1) %>% select(V1, V4, V5)
NC.6.2$Group <- c("Latino/a")
NC.6.2$State <- c("CA")

NC.6.3 <- read.csv("PowerStats admfpj.csv", header=FALSE, skip=(131 - 1), nrow=1) %>% select(V1, V4, V5)
NC.6.3$Group <- c("Pacific Islander")
NC.6.3$State <- c("CA")

NC.6.4 <- read.csv("PowerStats admfpj.csv", header=FALSE, skip=(129 - 1), nrow=1) %>% select(V1, V4, V5)
NC.6.4$Group <- c("Asian")
NC.6.4$State <- c("CA")

NC.6.5 <- read.csv("PowerStats admfpj.csv", header=FALSE, skip=(126 - 1), nrow=1) %>% select(V1, V4, V5)
NC.6.5$Group <- c("White")
NC.6.5$State <- c("CA")

NC.6.6 <- read.csv("PowerStats admfpj.csv", header=FALSE, skip=(124 - 1), nrow=1) %>% select(V1, V4, V5)
NC.6.6$Group <- c("Overall")
NC.6.6$State <- c("CA")

NC.6 <- rbind(NC.6.1, NC.6.2, NC.6.3, NC.6.4, NC.6.5, NC.6.6)
NC.6$`Measure` <- rep("Share with undergraduate loans by graduation", nrow(NC.6))
NC.6$`Figure` <- rep("Figure 5", nrow(NC.6))
NC.6$`Type` <- rep("Percentage", nrow(NC.6))
```

```{r check.NPSAS7}
# Figure 5: Average loan 
# Overall CA             # Line 119, B-C
# Black in CA            # Line 122, B-C
# Latino in CA           # Line 123, B-C
# Pacific Islander in CA # Line 126, B-C
# Asian in CA            # Line 124, B-C
# White in CA            # Line 121, B-C
# File: "PowerStats rcefsb.csv"

NC.7.1 <- read.csv("PowerStats rcefsb.csv", header=FALSE, skip=(119 - 1), nrow=1) %>% select(V1, V2, V3)
NC.7.1$Group <- c("Overall")
NC.7.1$State <- c("CA")

NC.7.2 <- read.csv("PowerStats rcefsb.csv", header=FALSE, skip=(122 - 1), nrow=1) %>% select(V1, V2, V3)
NC.7.2$Group <- c("Black")
NC.7.2$State <- c("CA")

NC.7.3 <- read.csv("PowerStats rcefsb.csv", header=FALSE, skip=(123 - 1), nrow=1) %>% select(V1, V2, V3)
NC.7.3$Group <- c("Latino/a")
NC.7.3$State <- c("CA")

NC.7.4 <- read.csv("PowerStats rcefsb.csv", header=FALSE, skip=(126 - 1), nrow=1) %>% select(V1, V2, V3)
NC.7.4$Group <- c("Pacific Islander")
NC.7.4$State <- c("CA")

NC.7.5 <- read.csv("PowerStats rcefsb.csv", header=FALSE, skip=(124 - 1), nrow=1) %>% select(V1, V2, V3)
NC.7.5$Group <- c("Asian")
NC.7.5$State <- c("CA")

NC.7.6 <- read.csv("PowerStats rcefsb.csv", header=FALSE, skip=(121 - 1), nrow=1) %>% select(V1, V2, V3)
NC.7.6$Group <- c("White")
NC.7.6$State <- c("CA")

NC.7 <- rbind(NC.7.1, NC.7.2, NC.7.3, NC.7.4, NC.7.5, NC.7.6)
NC.7$`Measure` <- rep("Average cumulative undergraduate loan at graduation", nrow(NC.7))
NC.7$`Figure` <- rep("Figure 5", nrow(NC.7))
NC.7$`Type` <- rep("Dollar", nrow(NC.7))
```

```{r check.NPSAS.end}
names(NC.1)[1:3] <- c("GroupNameCheck", "Estimate", "95% Confidence Interval")
names(NC.2)[1:3] <- c("GroupNameCheck", "Estimate", "95% Confidence Interval")
names(NC.3)[1:3] <- c("GroupNameCheck", "Estimate", "95% Confidence Interval")
names(NC.4)[1:3] <- c("GroupNameCheck", "Estimate", "95% Confidence Interval")
names(NC.5)[1:3] <- c("GroupNameCheck", "Estimate", "95% Confidence Interval")
names(NC.6)[1:3] <- c("GroupNameCheck", "Estimate", "95% Confidence Interval")
names(NC.7)[1:3] <- c("GroupNameCheck", "Estimate", "95% Confidence Interval")
NC <- rbind(NC.1, NC.2, NC.3, NC.4, NC.5, NC.6, NC.7)

setDT(NC)[, paste0("95% Confidence Interval", 1:3) := tstrsplit(`95% Confidence Interval`, " ")]

NC <- NC %>% rename(`Conf. Int. Lower Bound` = `95% Confidence Interval1`)
NC <- NC %>% rename(`Conf. Int. Upper Bound` = `95% Confidence Interval3`)
NC <- NC %>% select(!(`95% Confidence Interval2`))

NC$`Estimate` <- gsub(",", "", NC$`Estimate`)
NC$`Conf. Int. Lower Bound` <- gsub(",", "", NC$`Conf. Int. Lower Bound`)
NC$`Conf. Int. Upper Bound` <- gsub(",", "", NC$`Conf. Int. Upper Bound`)

for(i in (1:nrow(NC))){
  if(NC$Type[i]=="Percentage"){
    NC$Estimate[i] <- percent((as.numeric(NC$Estimate[i]) / 100), accuracy=0.1)
    NC$`Conf. Int. Lower Bound`[i] <- percent((as.numeric(NC$`Conf. Int. Lower Bound`[i]) / 100), accuracy=0.1)
    NC$`Conf. Int. Upper Bound`[i] <- percent((as.numeric(NC$`Conf. Int. Upper Bound`[i]) / 100), accuracy=0.1)
  }
  if(NC$Type[i]=="Dollar"){
    NC$Estimate[i] <- dollar(as.numeric(NC$Estimate[i]), accuracy=1)
    NC$`Conf. Int. Lower Bound`[i] <- dollar(as.numeric(NC$`Conf. Int. Lower Bound`[i]), accuracy=1)
    NC$`Conf. Int. Upper Bound`[i] <- dollar(as.numeric(NC$`Conf. Int. Upper Bound`[i]), accuracy=1)
  }
}
NC.final <- NC %>% select(`Measure`, `Figure`, `Group`, `State`, `Conf. Int. Lower Bound`, `Estimate`, `Conf. Int. Upper Bound`)
kable(NC.final, caption="Checking confidence intervals of NPSAS analyses") %>% kable_paper("hover", full_width = F) %>% scroll_box(height = "400px")
```
#### Data Source and Notes

**Data source:** National Postsecondary Student Aid Study. Datalab interface available [here](https://nces.ed.gov/datalab/). See the data notes under the specified figures for more details about individual analyses summarized here. 
...
tblHomeOwn0$Race <- factor(tblHomeOwn0$Race, levels=c("All", 
                                                      "Other, Non-Hispanic", 
                                                      "White, Non-Hispanic", 
                                                      "Hispanic", 
                                                      "Black, Non-Hispanic"))

tblHomeOwn0 <- tblHomeOwn0 %>% filter(Race != "All")
ggplot(data=tblHomeOwn0, mapping=aes(y=`Share who own home`, x=Race, fill=State)) + geom_bar(stat="identity", position="dodge", width=0.5) + scale_y_continuous(labels=scales::percent_format(accuracy=1)) + labs(y="Share who own their own home", x="Group", title="Share of student loan borrowers who own their home") + theme(text=element_text(family="Optima")) + scale_fill_manual(values = stateCols2)
write.csv(tblHomeOwn0, "california-figure6-data.csv", row.names=FALSE)
```
...
tblFinManage0 <- tblFinManage0 %>% filter(AnyStudentLoans=="Yes") 
# tblFinManage0 <- tblFinManage0 %>% filter(Race != "Other, Non-Hispanic")
tblFinManage0$Race <- as.factor(tblFinManage0$Race)
tblFinManage0$Race <- factor(tblFinManage0$Race, levels=c("All", 
                                                          "White, Non-Hispanic",
                                                          "Other, Non-Hispanic", 
                                                          "Hispanic", 
                                                          "Black, Non-Hispanic"))

tblFinManage0 <- tblFinManage0 %>% filter(Race != "All")
...
write.csv(tblFinManage0, "california-figure7-data.csv", row.names=FALSE)

```

```{r forPolicyReport3, eval=FALSE}
# tblOwnDebtCC0 <- tblOwnDebtCC %>% filter(Race != "Other, Non-Hispanic") 
tblOwnDebtCC0 <- tblOwnDebtCC %>% filter(Race != "All")
tblOwnDebtCC0$Race <- as.factor(tblOwnDebtCC0$Race)
tblOwnDebtCC0$Race <- factor(tblOwnDebtCC0$Race, levels=c("Black, Non-Hispanic", "Hispanic", "Other, Non-Hispanic", "White, Non-Hispanic"))
...
write.csv(tblOwnDebtCC0, "california-figure8-data.csv", row.names=FALSE)
...
agg1 <- agg1 %>% mutate(`Enrollment share` = percent(`value` / (agg1$value[1] - (agg1$value[9] + agg1$value[10])), accuracy=0.1))
agg1 <- agg1 %>% filter((variable %in% c("EFYTOTLT", "EFYNRALT", "EFYUNKNT"))==FALSE)

pusa21 <- fread("psam2021_pusa.csv", header=TRUE, select=c(
  "SERIALNO",
  "ST",
  "PWGTP",
  "RAC1P", 
...
pusb21 <- fread("psam2021_pusb.csv", header=TRUE, select=c(
  "SERIALNO",
  "ST",
  "PWGTP",
  "RAC1P", 
...
agg2 <- agg2 %>% mutate(`Population share` = percent(`PWGTP` / sum(agg2$PWGTP), accuracy=0.1))


```

```{r forPolicyReport8, eval=FALSE}

loanfile22 <- "dl-dashboard-ay2021-2022-q4-california.csv"
loanfile21 <- "dl-dashboard-ay2020-2021-q4-california.csv"
loanfile20 <- "dl-dashboard-ay2019-2020-q4-california.csv"
loanfile19 <- "dl-dashboard-ay2018-2019-q4-california.csv"
loanfile18 <- "DL_Dashboard_AY2017_2018_Q4-california.csv"
loanfile17 <- "DL_Dashboard_AY2016_2017_Q4-california.csv"
loanfile16 <- "DL_Dashboard_AY2015_2016_Q4-california.csv"
loanfile15 <- "DL_Dashboard_AY2014_2015_Q4-california.csv"
loanfile14 <- "DL_Dashboard_AY2013_2014_Q4-california.csv"
loanfile13 <- "DL_Dashboard_AY2012_2013_Q4-california.csv"
loanfile12 <- "DL_Dashboard_AY2011_2012_Q4-california.csv"
loanfile11 <- "DL_Dashboard_AY2010_2011_Q4-california.csv"
loanfile10 <- "DL_Dashboard_AY2009_2010_Q4-california.csv"
loanfile09 <- "DL_Dashboard_AY2008_2009_Q4-california.csv"
loanfile08 <- "DL_Dashboard_AY2007_2008_Q4-california.csv"
loanfile07 <- "DL_Dashboard_AY2006_2007_Q4-california.csv"
loanfile06 <- "DL_AwardYr_Summary_AY2005_2006_All-california.csv"

# 2012-13 to 2021-22
colnames1 <- c(
  "OPEID",  "School",  "State",  "Zip Code",  "School Type",

  "SUBSIDIZED: Recipients",   "SUBSIDIZED: # of Loans Originated",   "SUBSIDIZED: $ of Loans Originated",   "SUBSIDIZED: # of Disbursements",   "SUBSIDIZED: $ of Disbursements", 
   
  "UNSUBSIDIZED - UNDERGRADUATE: Recipients",   "UNSUBSIDIZED - UNDERGRADUATE: # of Loans Originated",   "UNSUBSIDIZED - UNDERGRADUATE: $ of Loans Originated",   "UNSUBSIDIZED - UNDERGRADUATE: # of Disbursements",   "UNSUBSIDIZED - UNDERGRADUATE: $ of Disbursements", 

  "UNSUBSIDIZED - GRADUATE: Recipients",   "UNSUBSIDIZED - GRADUATE: # of Loans Originated",   "UNSUBSIDIZED - GRADUATE: $ of Loans Originated",   "UNSUBSIDIZED - GRADUATE: # of Disbursements",   "UNSUBSIDIZED - GRADUATE: $ of Disbursements", 

  "PARENT PLUS: Recipients",   "PARENT PLUS: # of Loans Originated",   "PARENT PLUS: $ of Loans Originated",   "PARENT PLUS: # of Disbursements",   "PARENT PLUS: $ of Disbursements", 

  "GRAD PLUS: Recipients",   "GRAD PLUS: # of Loans Originated",   "GRAD PLUS: $ of Loans Originated",   "GRAD PLUS: # of Disbursements",   "GRAD PLUS: $ of Disbursements"
)
...
colnames2 <- c(
  ...
  "SUBSIDIZED - UNDERGRADUATE: Recipients",   "SUBSIDIZED - UNDERGRADUATE: # of Loans Originated",   "SUBSIDIZED - UNDERGRADUATE: $ of Loans Originated",   "SUBSIDIZED - UNDERGRADUATE: # of Disbursements",   "SUBSIDIZED - UNDERGRADUATE: $ of Disbursements", 
  
  "SUBSIDIZED - GRADUATE: Recipients",   "SUBSIDIZED - GRADUATE: # of Loans Originated",   "SUBSIDIZED - GRADUATE: $ of Loans Originated",   "SUBSIDIZED - GRADUATE: # of Disbursements",   "SUBSIDIZED - GRADUATE: $ of Disbursements", 
...
colnames3 <- c(
  ...
  "UNSUBSIDIZED: Recipients",   "UNSUBSIDIZED: # of Loans Originated",   "UNSUBSIDIZED: $ of Loans Originated",   "UNSUBSIDIZED: # of Disbursements",   "UNSUBSIDIZED: $ of Disbursements", 
...
derivePLUStotals <- function(loansyear, loanfile, nskip, colnames, index) {
  loans <- fread(loanfile, header=TRUE, skip=nskip) 
  names(loans) <- colnames
  ...
  if(index==1){
    ...
    loans$State[loans$OPEID==188100] <- "Ashford"
    
    loans$`SUBSIDIZED: $ of Disbursements` <- as.numeric(loans$`SUBSIDIZED: $ of Disbursements`)
    loans$`SUBSIDIZED: $ of Disbursements`[is.na(loans$`SUBSIDIZED: $ of Disbursements`)] <- 0
    
    loans$`UNSUBSIDIZED - UNDERGRADUATE: $ of Disbursements` <- as.numeric(loans$`UNSUBSIDIZED - UNDERGRADUATE: $ of Disbursements`)
    loans$`UNSUBSIDIZED - UNDERGRADUATE: $ of Disbursements`[is.na(loans$`UNSUBSIDIZED - UNDERGRADUATE: $ of Disbursements`)] <- 0
    
    loans$`UNSUBSIDIZED - GRADUATE: $ of Disbursements` <- as.numeric(loans$`UNSUBSIDIZED - GRADUATE: $ of Disbursements`)
    loans$`UNSUBSIDIZED - GRADUATE: $ of Disbursements`[is.na(loans$`UNSUBSIDIZED - GRADUATE: $ of Disbursements`)] <- 0
    
    loans$`PARENT PLUS: $ of Disbursements` <- as.numeric(loans$`PARENT PLUS: $ of Disbursements`)
    loans$`PARENT PLUS: $ of Disbursements`[is.na(loans$`PARENT PLUS: $ of Disbursements`)] <- 0
    
    loans$`GRAD PLUS: $ of Disbursements` <- as.numeric(loans$`GRAD PLUS: $ of Disbursements`)
    loans$`GRAD PLUS: $ of Disbursements`[is.na(loans$`GRAD PLUS: $ of Disbursements`)] <- 0
    
    loans <- loans %>% mutate(`Total $ of Disbursements` = `SUBSIDIZED: $ of Disbursements` + `UNSUBSIDIZED - UNDERGRADUATE: $ of Disbursements` + `UNSUBSIDIZED - GRADUATE: $ of Disbursements` + `PARENT PLUS: $ of Disbursements` + `GRAD PLUS: $ of Disbursements`)
    loans <- loans %>% select(`OPEID`, `State`, `Total $ of Disbursements`, `PARENT PLUS: $ of Disbursements`, `GRAD PLUS: $ of Disbursements`)
  }
  ...
  if(index==2){
    loans <- loans %>% select(
      `OPEID`,
      `State`, 
      `SUBSIDIZED - UNDERGRADUATE: $ of Disbursements`, 
      `SUBSIDIZED - GRADUATE: $ of Disbursements`, 
      `UNSUBSIDIZED - UNDERGRADUATE: $ of Disbursements`, 
      `UNSUBSIDIZED - GRADUATE: $ of Disbursements`, 
      `PARENT PLUS: $ of Disbursements`, 
      `GRAD PLUS: $ of Disbursements`
    ...
    loans$`SUBSIDIZED - UNDERGRADUATE: $ of Disbursements` <- as.numeric(loans$`SUBSIDIZED - UNDERGRADUATE: $ of Disbursements`)
    loans$`SUBSIDIZED - UNDERGRADUATE: $ of Disbursements`[is.na(loans$`SUBSIDIZED - UNDERGRADUATE: $ of Disbursements`)] <- 0
    
    loans$`SUBSIDIZED - GRADUATE: $ of Disbursements` <- as.numeric(loans$`SUBSIDIZED - GRADUATE: $ of Disbursements`)
    loans$`SUBSIDIZED - GRADUATE: $ of Disbursements`[is.na(loans$`SUBSIDIZED - GRADUATE: $ of Disbursements`)] <- 0
    ...
    loans <- loans %>% mutate(`Total $ of Disbursements` = `SUBSIDIZED - UNDERGRADUATE: $ of Disbursements` + `SUBSIDIZED - GRADUATE: $ of Disbursements` + `UNSUBSIDIZED - UNDERGRADUATE: $ of Disbursements` + `UNSUBSIDIZED - GRADUATE: $ of Disbursements` + `PARENT PLUS: $ of Disbursements` + `GRAD PLUS: $ of Disbursements`)
    loans <- loans %>% select(`OPEID`, `State`, `Total $ of Disbursements`, `PARENT PLUS: $ of Disbursements`, `GRAD PLUS: $ of Disbursements`)
  }
  ...
  if(index==3){
    ...
    loans$`UNSUBSIDIZED: $ of Disbursements` <- as.numeric(loans$`UNSUBSIDIZED: $ of Disbursements`)
    loans$`UNSUBSIDIZED: $ of Disbursements`[is.na(loans$`UNSUBSIDIZED: $ of Disbursements`)] <- 0
    ...
    loans <- loans %>% mutate(`Total $ of Disbursements` = `SUBSIDIZED: $ of Disbursements` + `UNSUBSIDIZED: $ of Disbursements` + `PARENT PLUS: $ of Disbursements` + `GRAD PLUS: $ of Disbursements`)
    loans <- loans %>% select(`OPEID`, `State`, `Total $ of Disbursements`, `PARENT PLUS: $ of Disbursements`, `GRAD PLUS: $ of Disbursements`)
  }
  
  loans$`State`[loans$`State` != "CA"] <- "Rest of U.S."
  results <- aggregate(data=loans, cbind(`Total $ of Disbursements`, `PARENT PLUS: $ of Disbursements`, `GRAD PLUS: $ of Disbursements`) ~ State, FUN=sum)
  
  results <- results %>% mutate(`PARENT PLUS share of total` = `PARENT PLUS: $ of Disbursements` / `Total $ of Disbursements`)
  results <- results %>% mutate(`GRAD PLUS share of total` = `GRAD PLUS: $ of Disbursements` / `Total $ of Disbursements`)
  results$Year <- rep(loansyear, nrow(results))
  return(results)
}

plusOverTime <- rbind(
  derivePLUStotals(loansyear = 2006, loanfile = loanfile06, nskip = nskip06, colnames = colnames3, index=3),
  derivePLUStotals(loansyear = 2007, loanfile = loanfile07, nskip = nskip07, colnames = colnames3, index=3),
  derivePLUStotals(loansyear = 2008, loanfile = loanfile08, nskip = nskip08, colnames = colnames3, index=3), 
  derivePLUStotals(loansyear = 2009, loanfile = loanfile09, nskip = nskip09, colnames = colnames3, index=3), 
  derivePLUStotals(loansyear = 2010, loanfile = loanfile10, nskip = nskip10, colnames = colnames3, index=3), 
  derivePLUStotals(loansyear = 2011, loanfile = loanfile11, nskip = nskip11, colnames = colnames2, index=2), 
  derivePLUStotals(loansyear = 2012, loanfile = loanfile12, nskip = nskip12, colnames = colnames2, index=2), 
  derivePLUStotals(loansyear = 2013, loanfile = loanfile13, nskip = nskip13, colnames = colnames1, index=1), 
  derivePLUStotals(loansyear = 2014, loanfile = loanfile14, nskip = nskip14, colnames = colnames1, index=1), 
  derivePLUStotals(loansyear = 2015, loanfile = loanfile15, nskip = nskip15, colnames = colnames1, index=1), 
  derivePLUStotals(loansyear = 2016, loanfile = loanfile16, nskip = nskip16, colnames = colnames1, index=1), 
  derivePLUStotals(loansyear = 2017, loanfile = loanfile17, nskip = nskip17, colnames = colnames1, index=1), 
  derivePLUStotals(loansyear = 2018, loanfile = loanfile18, nskip = nskip18, colnames = colnames1, index=1), 
  derivePLUStotals(loansyear = 2019, loanfile = loanfile19, nskip = nskip19, colnames = colnames1, index=1), 
  derivePLUStotals(loansyear = 2020, loanfile = loanfile20, nskip = nskip20, colnames = colnames1, index=1), 
  derivePLUStotals(loansyear = 2021, loanfile = loanfile21, nskip = nskip21, colnames = colnames1, index=1), 
  derivePLUStotals(loansyear = 2022, loanfile = loanfile22, nskip = nskip22, colnames = colnames1, index=1)
)

plusOverTime <- plusOverTime %>% select(`State`, `Year`, `PARENT PLUS share of total`, `GRAD PLUS share of total`)
names(plusOverTime) <- c("State", "Year", "Parent PLUS", "Grad PLUS")
plusOverTime <- reshape2::melt(data=plusOverTime, id.vars=c("State", "Year"))
plusOverTime$Loan <- rep(NA, nrow(plusOverTime))
plusOverTime$Loan[(plusOverTime$variable=="Parent PLUS") & (plusOverTime$State=="CA")] <- "Parent PLUS share of loan dollars in California"
plusOverTime$Loan[(plusOverTime$variable=="Grad PLUS") & (plusOverTime$State=="CA")] <- "Grad PLUS share of loan dollars in California"
plusOverTime$Loan[(plusOverTime$variable=="Parent PLUS") & (plusOverTime$State=="Rest of U.S.")] <- "Parent PLUS share of loan dollars in rest of U.S."
plusOverTime$Loan[(plusOverTime$variable=="Grad PLUS") & (plusOverTime$State=="Rest of U.S.")] <- "Grad PLUS share of loan dollars in rest of U.S."

loancolors <- c(
  "purple3",   "purple1",   "dodgerblue3",   "dodgerblue1"
)

ggplot(data=plusOverTime, mapping=aes(x=Year, y=value, color=Loan, linetype=State)) + geom_point(stat="identity") + geom_line(stat="identity") + scale_y_continuous(labels=percent_format(accuracy=1)) + scale_color_manual(values=loancolors) + theme(legend.title=element_blank(), text=element_text(family="Optima"), axis.text = element_text(size = 7)) + labs(x="Year", y="Share of all loan dollars")
```

```{r forPolicyReport9, eval=FALSE}
shed.DebtVsInc <- shed %>% filter(`TotalInc` %in% c("Refused", "") == FALSE) %>% filter(`OwnDebtTot3` %in% c("") == FALSE) %>% filter(is.na(OwnDebtTot3)==FALSE)
shed.DebtVsInc$DebtThreshold <- rep(NA, nrow(shed.DebtVsInc))
shed.DebtVsInc$IncThreshold <- rep(NA, nrow(shed.DebtVsInc))

shed.DebtVsInc$DebtThreshold[shed.DebtVsInc$OwnDebtTot3=="Less than $5,000"] <- 5000
shed.DebtVsInc$DebtThreshold[shed.DebtVsInc$OwnDebtTot3=="$5,000 to $9,999"] <- 15000
shed.DebtVsInc$DebtThreshold[shed.DebtVsInc$OwnDebtTot3=="$10,000 to $14,999"] <- 15000
shed.DebtVsInc$DebtThreshold[shed.DebtVsInc$OwnDebtTot3=="$15,000 to $19,999"] <- 25000
shed.DebtVsInc$DebtThreshold[shed.DebtVsInc$OwnDebtTot3=="$20,000 to $24,999"] <- 25000
shed.DebtVsInc$DebtThreshold[shed.DebtVsInc$OwnDebtTot3=="$25,000 to $29,999"] <- 40000
shed.DebtVsInc$DebtThreshold[shed.DebtVsInc$OwnDebtTot3=="$30,000 to $39,999"] <- 40000
shed.DebtVsInc$DebtThreshold[shed.DebtVsInc$OwnDebtTot3=="$40,000 to $49,999"] <- 50000
shed.DebtVsInc$DebtThreshold[shed.DebtVsInc$OwnDebtTot3=="$50,000 to $74,999"] <- 75000
shed.DebtVsInc$DebtThreshold[shed.DebtVsInc$OwnDebtTot3=="$75,000 to $99,999"] <- 100000
shed.DebtVsInc$DebtThreshold[shed.DebtVsInc$OwnDebtTot3=="$100,000 or above"] <- 999999

shed.DebtVsInc$IncThreshold[shed.DebtVsInc$TotalInc=="$0 to $4,999"] <- 5000
shed.DebtVsInc$IncThreshold[shed.DebtVsInc$TotalInc=="$5,000 to $14,999"] <- 15000
shed.DebtVsInc$IncThreshold[shed.DebtVsInc$TotalInc=="$15,000 to $24,999"] <- 25000
shed.DebtVsInc$IncThreshold[shed.DebtVsInc$TotalInc=="$25,000 to $39,999"] <- 40000
shed.DebtVsInc$IncThreshold[shed.DebtVsInc$TotalInc=="$40,000 to $49,999"] <- 50000
shed.DebtVsInc$IncThreshold[shed.DebtVsInc$TotalInc=="$50,000 to $74,999"] <- 75000
shed.DebtVsInc$IncThreshold[shed.DebtVsInc$TotalInc=="$75,000 to $99,999"] <- 100000
shed.DebtVsInc$IncThreshold[shed.DebtVsInc$TotalInc=="$100,000 to $149,999"] <- 999999
shed.DebtVsInc$IncThreshold[shed.DebtVsInc$TotalInc=="$150,000 to $199,999"] <- 999999
shed.DebtVsInc$IncThreshold[shed.DebtVsInc$TotalInc=="$200,000 or higher"] <- 999999

shed.DebtVsInc$DebtVsInc <- rep(NA, nrow(shed.DebtVsInc))
shed.DebtVsInc$DebtVsInc[shed.DebtVsInc$DebtThreshold < shed.DebtVsInc$IncThreshold] <- "Debt is less than income"
shed.DebtVsInc$DebtVsInc[shed.DebtVsInc$DebtThreshold == shed.DebtVsInc$IncThreshold] <- "Debt is roughly equal to income"
shed.DebtVsInc$DebtVsInc[shed.DebtVsInc$DebtThreshold > shed.DebtVsInc$IncThreshold] <- "Debt is greater than income"

tblDebtVsInc <- aggregate(data=shed.DebtVsInc, Weight ~ DebtVsInc + Race + State, FUN=sum)
tblDebtVsInc2 <- aggregate(data=shed.DebtVsInc, Weight ~ DebtVsInc + State, FUN=sum)
tblDebtVsInc2$Race <- rep("All", nrow(tblDebtVsInc2))
tblDebtVsInc <- rbind(tblDebtVsInc, tblDebtVsInc2)
tblDebtVsInc <- reshape2::dcast(data=tblDebtVsInc, Race + State ~ DebtVsInc, value.var="Weight")
tblDebtVsInc$`Total weight` <- tblDebtVsInc$`Debt is less than income` + tblDebtVsInc$`Debt is roughly equal to income` + tblDebtVsInc$`Debt is greater than income`
tblDebtVsInc$`Debt is less than income` <- tblDebtVsInc$`Debt is less than income` / tblDebtVsInc$`Total weight`
tblDebtVsInc$`Debt is roughly equal to income` <- tblDebtVsInc$`Debt is roughly equal to income` / tblDebtVsInc$`Total weight`
tblDebtVsInc$`Debt is greater than income` <- tblDebtVsInc$`Debt is greater than income` / tblDebtVsInc$`Total weight`
tblDebtVsInc <- reshape2::melt(data=tblDebtVsInc, id.vars=c("Race", "State"), value.name="Share of borrowers") 
tblDebtVsInc <- tblDebtVsInc %>% filter(variable != "Total weight")

tblDebtVsInc$variable <- factor(tblDebtVsInc$variable, levels=c(
  "Debt is greater than income",
  "Debt is roughly equal to income", 
  "Debt is less than income"
))

tblDebtVsInc$`For Tooltip` <- paste(
  "State: ", tblDebtVsInc$State, '\n',
  "Group: ", tblDebtVsInc$Race, '\n',
  "Category: ", tblDebtVsInc$variable, '\n',
  "Share: ", percent(tblDebtVsInc$`Share of borrowers`, accuracy=0.1),
  sep=""
)

gFP9 <- ggplot(data=tblDebtVsInc, mapping=aes(y=Race, x=`Share of borrowers`, fill=variable, text=`For Tooltip`)) + geom_bar(stat="identity") + facet_grid(State ~ .) + scale_x_continuous(labels=scales::percent_format(accuracy=1)) + labs(fill="", x="Share of student loan borrowers", y="") + theme(text=element_text(family="Optima")) + scale_fill_brewer(palette="Spectral") 

ggplotly(gFP9, width=800, height=350, tooltip="text")
```

```{r forPolicyReport10, eval=FALSE}
tblOwnDebt$Race <- factor(tblOwnDebt$Race, levels=rev(c("All", "White, Non-Hispanic", "Other, Non-Hispanic", "Hispanic", "Black, Non-Hispanic")))
# tblOwnDebt <- tblOwnDebt %>% filter(Race != "Other, Non-Hispanic")

tblOwnDebt <- tblOwnDebt %>% filter(Race != "All")
ggplot(data=tblOwnDebt, mapping=aes(x=Race, y=`Share with debt`, fill=State, text=`For Tooltip`)) + geom_bar(stat="identity", position="dodge", width=0.7) + scale_y_continuous(labels=scales::percent_format(accuracy=1)) + labs(x="Group", title="", y="Share with education debt") + theme(text=element_text(family="Optima")) + scale_fill_manual(values = stateCols2)
write.csv(tblOwnDebt, "california-figure5-data.csv", row.names=FALSE)
```

```{r forPolicyReport11, eval=FALSE}
npsas2P$Group <- factor(npsas2P$Group, levels=rev(c("Asian", "White", "Overall", "Latino/a", "Black")))
gFP11 <- ggplot(data=npsas2P, mapping=aes(x=Group, y=`Share Borrowing Loans`, fill=State, text=`For Tooltip`)) + geom_bar(stat="identity", position="dodge", width=0.6) + labs(title="", y="Share Borrowing Loans", x="Group") + scale_y_continuous(labels=scales::percent_format(accuracy=1)) + scale_fill_manual(values = stateCols2) + theme(legend.position="right", text=element_text(family="Optima"))

ggplotly(gFP11, width=800, height=350, tooltip="text")
write.csv(npsas2P, "california-figure4-data.csv", row.names=FALSE)
```

```{r forPolicyReport12, eval=FALSE}
npsas4P <- npsas4P %>% filter(Group != "2+ races")
npsas4P$Group <- factor(npsas4P$Group, levels=rev(c("Asian", "Latino/a", "White", "Overall", "Pacific Islander", "Black")))
gFP12 <- ggplot(data=npsas4P, mapping=aes(x=Group, y=`Share with Cumulative Loans`, fill=State, text=`For Tooltip`)) + geom_bar(stat="identity", position="dodge", width=0.6) + scale_y_continuous(label=scales::percent_format(accuracy=1)) + labs(x="Group", title="", y="Share with Cumulative Loans") + scale_fill_manual(values = stateCols2) + theme(legend.position="right", text=element_text(family="Optima"))

ggplotly(gFP12, width=800, height=350, tooltip="text")
write.csv(npsas4P, "california-figure3-data.csv", row.names=FALSE)
```

```{r forPolicyReport13, eval=FALSE}
CSI4 <- fread("Most-Recent-Cohorts-Institution.csv", header=TRUE, select=c(
  ...
  "MAIN",                       # Main campus
  "PLUS_DEBT_INST_MD",          # Median PLUS loan debt disbursed at this institution
  "PPLUS_PCT_LOW_POOLED_SUPP",  # Lower bound of estimated percentage range of students whose parents took out a PLUS loan, pooled in rolling averages and suppressed for small n size
  "PPLUS_PCT_HIGH_POOLED_SUPP"  # Upper bound of estimated percentage range of students whose parents took out a PLUS loan, pooled in rolling averages and suppressed for small n size
)) 
CSI4 <- CSI4 %>% arrange(desc(`MAIN`)) %>% filter(duplicated(`OPEID6`)==FALSE) %>% filter(`STABBR`=="CA")
CSI4 <- CSI4 %>% mutate(`PPLUS_PCT_LOW_POOLED_SUPP` = as.numeric(`PPLUS_PCT_LOW_POOLED_SUPP`)) %>% mutate(`PPLUS_PCT_HIGH_POOLED_SUPP` = as.numeric(`PPLUS_PCT_HIGH_POOLED_SUPP`)) %>% mutate(`PLUS_DEBT_INST_MD` = as.numeric(`PLUS_DEBT_INST_MD`))

CSI4 <- CSI4 %>% filter((is.na(`PPLUS_PCT_LOW_POOLED_SUPP`)==FALSE) & (is.na(`PPLUS_PCT_HIGH_POOLED_SUPP`)==FALSE)) %>% filter(is.na(`PLUS_DEBT_INST_MD`)==FALSE)
```

```{r forLucy1, eval=FALSE}

loancolors <- c(
  "purple3",     "dodgerblue1"
)

plusOverTime <- plusOverTime %>% filter(Loan %in% c("Grad PLUS share of loan dollars in California", "Grad PLUS share of loan dollars in rest of U.S."))

FL1 <- ggplot(data=plusOverTime, mapping=aes(x=Year, y=value, color=State)) + geom_point(stat="identity") + geom_line(stat="identity") + scale_y_continuous(labels=percent_format(accuracy=1)) + scale_color_manual(values=stateCols) + theme(legend.title=element_blank(), text=element_text(family="Optima")) + labs(x="Year", y="Grard PLUS's share of all loan dollars")

ggplotly(FL1, width=700, height=470)
write.csv(plusOverTime, "california-figure9-data.csv", row.names=FALSE)

```

```{r forLucy2, eval=FALSE}

Q29.G <- Q29.G %>% filter(Control=="For-profit")

FL2 <- ggplot(data=Q29.G, mapping=aes(x=Year, y=`Average loan balance at year X`, group=State, text=`For Tooltip`)) + geom_point(aes(color=State)) + geom_line(aes(color=State)) + scale_y_continuous(labels=scales::dollar_format(), limits=c(0, (max(Q29.G$`Average loan balance at year X`)+2500))) + labs(x="Years into repayment on graduate loans from for-profits", y="Average loan balance at year X") + theme(text=element_text(family="Optima")) + scale_color_manual(values = stateCols)

ggplotly(FL2, width=700, height=470)
write.csv(Q29.G, "california-figure11-data.csv", row.names=FALSE)

```

```{r forLucy3, eval=FALSE}

Q29.P <- Q29.P %>% filter(Control=="For-profit")

FL3 <- ggplot(data=Q29.P, mapping=aes(x=Year, y=`Average loan balance at year X`, group=State, text=`For Tooltip`)) + geom_point(aes(color=State)) + geom_line(aes(color=State)) + scale_y_continuous(labels=scales::dollar_format(), limits=c(0, (max(Q29.G$`Average loan balance at year X`)+2500))) + labs(x="Years into repayment on parent loans from for-profits", y="Average loan balance at year X") + theme(text=element_text(family="Optima")) + scale_color_manual(values = stateCols)

ggplotly(FL3, width=700, height=470)
write.csv(Q29.P, "california-figure10-data.csv", row.names=FALSE)

```

```{r forAshley, eval=TRUE}
write.csv(Q6.TotalStaffordDebt, "Q6-TotalStaffordDebt.csv", row.names=FALSE)
write.csv(Q6.TotalParentDebt, "Q6-TotalParentDebt.csv", row.names=FALSE)
write.csv(Q6.TotalGradDebt, "Q6-TotalGradDebt.csv", row.names=FALSE)
write.csv(Q6.TotalDebt, "Q6-TotalDebt.csv", row.names=FALSE)
write.csv(Q22.S, "Q22-S.csv", row.names=FALSE)
write.csv(Q22.P, "Q22-P.csv", row.names=FALSE)
write.csv(Q22.G, "Q22-G.csv", row.names=FALSE)
write.csv(CSI3, "CSI3.csv", row.names=FALSE)
```
